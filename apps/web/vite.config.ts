...
const securityHeaders = {
  ...
  'Content-Security-Policy': [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' https://challenges.cloudflare.com https://*.clerk.accounts.dev https://*.clerk.dev https://clerk.com https://*.clerk.com https://clerk.beamlabultimate.tech https://unpkg.com blob:",
    ...
    "connect-src 'self' https://*.beamlabultimate.tech https://beamlab-backend-node.azurewebsites.net https://beamlab-backend-python.azurewebsites.net https://beamlab-rust-api.azurewebsites.net https://*.azurewebsites.net https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev wss://*.clerk.accounts.dev wss://clerk.beamlabultimate.tech https://api.anthropic.com https://generativelanguage.googleapis.com https://raw.githack.com https://dl.polyhaven.org https://*.polyhaven.org https://raw.githubusercontent.com https://storage.googleapis.com https://unpkg.com",
