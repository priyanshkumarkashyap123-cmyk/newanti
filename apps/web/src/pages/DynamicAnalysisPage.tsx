...
export const DynamicAnalysisPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Header */}
      <div className="border-b border-slate-800 bg-gradient-to-r from-slate-900 via-indigo-900/30 to-slate-900">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mt-8 grid grid-cols-4 gap-4">
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
              ...
              <div className="text-xs text-slate-400">Analysis Types</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
              <div className="text-2xl font-bold text-emerald-400">53x</div>
              <div className="text-xs text-slate-400">Faster (Rust WASM)</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
              <div className="text-2xl font-bold text-blue-400">17+</div>
              <div className="text-xs text-slate-400">Design Codes</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
              <div className="text-2xl font-bold text-purple-400">100%</div>
              <div className="text-xs text-slate-400">Cloud Native</div>
            </div>
          </div>
        </div>
      </div>
          ...
          {analysisTypes.map((analysis) => {
            ...
            return (
              <Link
                ...
                className={`group relative bg-slate-900 rounded-2xl border border-slate-700 overflow-hidden transition-all hover:border-slate-600 hover:shadow-xl ${
