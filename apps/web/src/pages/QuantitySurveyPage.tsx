...
export default function QuantitySurveyPage() {
  ...
  useEffect(() => { document.title = 'Quantity Survey | BeamLab Ultimate'; }, []);
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <header className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            {members.size > 0 && (
              <button onClick={generateFromModel} className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors">
              ...
              <tbody>
                {boqItems.map(item => (
                  <tr key={item.id} className="border-t border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:bg-slate-800/30">
                    ...
                    <td className="p-3">
                      <button aria-label="Remove item" onClick={() => removeItem(item.id)} className="p-1 text-red-400 hover:text-red-300">
