        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="mt-2 space-y-2">
                        <div className="flex gap-1">
                            {[1, 2, 3, 4, 5].map((level) => (
                                <div
                                    key={level}
                                    className={`h-1 flex-1 rounded ${level <= passwordStrength.strength ? getStrengthColor() : 'bg-zinc-700'
                                        }`}
                                />
                            ))}
                        </div>
            ...
            <div>
                ...
                <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 bg-zinc-800 border rounded-lg text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-purple-500 ${formData.confirmPassword && formData.password !== formData.confirmPassword
                        ? 'border-red-500'
                        : 'border-zinc-700'
                        }`}
            ...
            <div className="grid grid-cols-2 gap-3">
                <button
                    ...
                    disabled={isLoading}
                    className="flex items-center justify-center gap-2 py-2.5 px-4 bg-zinc-800 border border-zinc-700 rounded-lg text-white hover:bg-zinc-700 transition-colors disabled:opacity-50"
                >
