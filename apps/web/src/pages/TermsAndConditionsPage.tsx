...
function TermsAndConditionsPage() {
  ...
  useEffect(() => { document.title = 'Terms & Conditions | BeamLab Ultimate'; }, []);
              ...
              <section id="engineering-disclaimer" className="mb-12 scroll-mt-24">
                <div className="p-6 bg-red-500/10 border-2 border-red-500/30 rounded-xl">
                  ...
                  <p className="text-red-200 leading-relaxed font-semibold mb-4">
                    BEAMLAB ULTIMATE IS A COMPUTATIONAL AID ONLY. IT IS NOT A SUBSTITUTE FOR PROFESSIONAL ENGINEERING JUDGMENT.
                  </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-blue-400 hover:underline"
                        >
                          grievance@beamlabultimate.tech
                        </a>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200/80 text-sm">
                        By creating an account or using BeamLab Ultimate, you acknowledge that you have read, understood, and
