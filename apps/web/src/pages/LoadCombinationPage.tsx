                  ...
                  return (
                    <div key={loadCase.id} className="bg-slate-800 p-4 rounded-lg flex items-center gap-3">
                      ...
                      <input
                        ...
                        className="flex-1 px-3 py-2 bg-slate-700 border border-slate-600 rounded text-white text-sm focus:border-amber-500 focus:outline-none"
                      ...
                      <select
                        ...
                        className="px-3 py-2 bg-slate-700 border border-slate-600 rounded text-white text-sm focus:border-amber-500 focus:outline-none"
                      >
