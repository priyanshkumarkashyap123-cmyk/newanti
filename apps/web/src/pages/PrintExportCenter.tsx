          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-100 dark:bg-slate-800/50 rounded-xl border border-slate-300 dark:border-slate-700/50 overflow-hidden">
              <div className="p-4 border-b border-slate-300 dark:border-slate-700 flex items-center justify-between">
                <h3 className="text-zinc-900 dark:text-white font-semibold">Export Items</h3>
                        ...
                        {items.map((item) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span
                                className={`flex-1 text-left text-sm ${item.selected ? "text-zinc-900 dark:text-white" : "text-slate-600 dark:text-slate-400"}`}
                              >
                                {item.name}
                              </span>
          ...
          <div className="lg:col-span-2 space-y-6">
            {activeTab === "print" && (
              <>
                ...
                <div className="bg-slate-100 dark:bg-slate-800/50 rounded-xl border border-slate-300 dark:border-slate-700/50">
                  <div className="p-4 border-b border-slate-300 dark:border-slate-700 flex items-center justify-between">
                    <h3 className="text-zinc-900 dark:text-white font-semibold">Print Preview</h3>
                  ...
                  {selectedFormat === "pdf" && (
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <select className="w-full px-3 py-2 bg-slate-200 dark:bg-slate-700 border border-slate-600 rounded-lg text-zinc-900 dark:text-white text-sm">
            ...
            {activeTab === "templates" && (
              <div className="bg-slate-100 dark:bg-slate-800/50 rounded-xl p-5 border border-slate-300 dark:border-slate-700/50">
                ...
                <button className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-slate-600 rounded-lg text-slate-600 dark:text-slate-400 hover:text-zinc-900 dark:hover:text-white hover:border-slate-500 transition-colors">
