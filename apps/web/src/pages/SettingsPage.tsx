...
const Toggle: FC<ToggleProps> = ({ enabled, onChange, label, description, statusText }) => (
    <div className="flex items-center justify-between gap-4 rounded-lg border border-zinc-700 bg-zinc-800 p-5">
        <div className="flex items-start gap-4">
            <div className="p-3 rounded bg-zinc-700/30 text-white">
    ...
    <div className="flex flex-col gap-2">
        ...
        <div className="relative">
            <select
                ...
                className="w-full appearance-none rounded-lg border border-zinc-700 bg-zinc-800 text-white h-12 px-4 pr-10 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all text-sm"
            >
                {options.map(opt => (
...
export const SettingsPage: FC = () => {
    ...
    return (
        <div className="min-h-screen bg-zinc-900 text-white flex">
            {/* Sidebar */}
            <aside className="w-72 flex-shrink-0 flex flex-col border-r border-zinc-800 bg-zinc-950">
                {/* App Header */}
                ...
                <div className="p-4 border-t border-zinc-800/50">
                    <button
                        ...
                        className="flex items-center gap-2 text-zinc-400 hover:text-white text-sm font-medium transition-colors w-full px-2 py-2"
                    >
            ...
            {/* Main Content */}
            <main className="flex-1 flex flex-col h-screen overflow-hidden bg-zinc-900 relative">
                {/* Header */}
                <header className="flex-shrink-0 h-16 border-b border-zinc-800 flex items-center justify-between px-8 bg-zinc-900/80 backdrop-blur-md sticky top-0 z-10">
                    <h2 className="text-xl font-bold tracking-tight text-white">
                        {NAV_ITEMS.find(n => n.id === activeTab)?.label}
                    </h2>
                    <div className="flex gap-3">
                        <button className="px-4 py-2 rounded-lg border border-zinc-700 text-zinc-400 text-sm font-medium hover:bg-zinc-800 hover:text-white transition-colors flex items-center gap-2">
                ...
                <div className="flex-1 overflow-y-auto p-8">
                    <div className="max-w-3xl flex flex-col gap-8 pb-12">
                            ...
                            <>
                                ...
                                <section className="flex flex-col gap-5">
                                    <div className="border-b border-zinc-700 pb-2">
                                        <h3 className="text-white text-lg font-medium">Solver Configuration</h3>
                                        <p className="text-zinc-400 text-sm mt-1">Configure the core computational engine parameters.</p>
                                    </div>
                                ...
                                <section className="flex flex-col gap-5 pt-4">
                                    <div className="border-b border-zinc-700 pb-2">
                                        <h3 className="text-white text-lg font-medium">Meshing & Discretization</h3>
                                        <p className="text-zinc-400 text-sm mt-1">Control the density and quality of the finite element mesh.</p>
                                    </div>
                                    <Slider
                                ...
                                <section className="flex flex-col gap-5 pt-4">
                                    <div className="border-b border-zinc-700 pb-2">
                                        <h3 className="text-white text-lg font-medium">Performance & Hardware</h3>
                                        <p className="text-zinc-400 text-sm mt-1">Manage computational resources and hardware acceleration.</p>
                                    </div>
                                    <Toggle
                                ...
                                <section className="flex flex-col gap-5 pt-4">
                                    <div className="border-b border-zinc-700 pb-2">
                                        <h3 className="text-white text-lg font-medium">Output Handling</h3>
                                    </div>
                                    <div className="grid grid-cols-1 gap-4">
                                        <label className="flex items-center p-4 rounded-lg border border-zinc-700 bg-zinc-800 cursor-pointer hover:border-blue-500/50 transition-colors">
                                            <input
                                                type="checkbox"
                                            ...
                                            />
                                            <div className="ml-3">
                                                <span className="block text-sm font-medium text-white">Auto-save Intermediate Results</span>
                                                <span className="block text-xs text-zinc-400">Save state after each iteration step (uses more disk space)</span>
                                            </div>
                                        </label>
                                        <label className="flex items-center p-4 rounded-lg border border-zinc-700 bg-zinc-800 cursor-pointer hover:border-blue-500/50 transition-colors">
                                            <input
                                            ...
                                            />
                                            <div className="ml-3">
                                                <span className="block text-sm font-medium text-white">Generate Analysis Report</span>
                                                <span className="block text-xs text-zinc-400">Create PDF summary after analysis completes</span>
                                            </div>
                                        </label>
                                    </div>
                                </section>
                        ...
                        {activeTab === 'general' && (
                            <section className="flex flex-col gap-5">
                                <div className="border-b border-zinc-700 pb-2">
                                    ...
                                    <p className="text-zinc-400 text-sm mt-1">Configure basic application preferences.</p>
                                </div>
                                <Select
                                    label="Language"
                                    value="en"
                        ...
                        {activeTab === 'display' && (
                            <section className="flex flex-col gap-5">
                                <div className="border-b border-zinc-700 pb-2">
                                    <h3 className="text-white text-lg font-medium">Display Settings</h3>
                                    <p className="text-zinc-400 text-sm mt-1">Customize the visual appearance.</p>
                                </div>
                                <Select
                                    label="Theme"
                                    value="dark"
                        ...
                        {activeTab === 'profile' && (
                            <section className="flex flex-col gap-5">
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-lg border border-zinc-700 bg-zinc-800">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-400 text-sm">user@beamlab.com</p>
                                    </div>
                                </div>
                                <Input
                                    label="Display Name"
