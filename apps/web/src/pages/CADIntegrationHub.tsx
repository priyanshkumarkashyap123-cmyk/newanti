              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.001"
                    className="w-full p-2 bg-gray-700 border border-gray-600 rounded text-slate-900 dark:text-white"
                  />
                </div>
              </div>
            </div>
        ...
        {(exportSettings.format === 'DWG' || exportSettings.format === 'DXF') && (
          <div>
            ...
            <select
              ...
              className="w-full md:w-1/3 p-3 bg-gray-700 border border-gray-600 rounded-lg text-slate-900 dark:text-white"
            >
              {dwgVersions.map((ver) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-slate-900 dark:text-white">
