            ...
            {!schedule ? (
              ...
              <>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white">{schedule.projectName}</h3>
                      ...
                      <tbody>
                        {schedule.entries.map((entry, idx) => (
                          <tr key={idx} className="border-b border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:bg-slate-800/50 transition-colors">
                            ...
                            <td className="px-4 py-3 text-slate-900 dark:text-white">{entry.memberRef}</td>
                            ...
                            <td className="px-4 py-3 text-right text-slate-900 dark:text-white">{entry.noPerMember}</td>
                            <td className="px-4 py-3 text-right text-slate-900 dark:text-white">{entry.noOfMembers}</td>
                            <td className="px-4 py-3 text-right text-slate-900 dark:text-white font-medium">{entry.totalBars}</td>
                            <td className="px-4 py-3 text-right text-slate-900 dark:text-white font-mono">{entry.cuttingLength}</td>
                            <td className="px-4 py-3 text-right text-slate-900 dark:text-white">{entry.totalLength.toFixed(2)}</td>
                        ...
                        {schedule.summary.map((row, idx) => {
                          ...
                          return (
                            <tr key={idx} className="border-b border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:bg-slate-800/50">
                              ...
                              <td className="px-5 py-3 text-right text-slate-900 dark:text-white">{row.totalLength.toFixed(2)}</td>
