 ...
 */
export function calculate_foundation_springs(length: number, width: number, soil_modulus_kpa: number, poisson_ratio: number): string;

/**
 * Calculate AISC 360-22 Direct Analysis Method notional loads
 * Returns notional load factors and second-order effects
 */
export function calculate_notional_loads(story_gravity_loads_json: string, story_heights_json: string, first_order_drift_ratio: number): string;
 ...
 */
export function calculate_von_mises(sigma_xx: number, sigma_yy: number, sigma_zz: number, tau_xy: number, tau_yz: number, tau_xz: number): string;

/**
 * Check IS 13920:2016 ductile detailing requirements for beams
 */
export function check_is13920_beam_ductility(width_mm: number, depth_mm: number, clear_span_mm: number, top_steel_mm2: number, bottom_steel_mm2: number, stirrup_dia_mm: number, stirrup_spacing_mm: number, fck_mpa: number, fy_mpa: number): string;

/**
 * Calculate seismic story drift per ASCE 7 / IS 1893 / EC8
 * Returns drift ratios and compliance status for each story
 */
export function check_seismic_drift(story_heights_json: string, story_displacements_json: string, code: string, importance_factor: number): string;

/**
 * Get solver and platform info
 */
export function get_platform_info(): string;
...
export interface InitOutput {
  ...
  readonly calculate_foundation_springs: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly calculate_notional_loads: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly calculate_seismic_base_shear: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly calculate_von_mises: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly check_is13920_beam_ductility: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
  readonly check_seismic_drift: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly get_platform_info: (a: number) => void;
