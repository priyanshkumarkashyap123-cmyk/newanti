...
export class ReportGenerator {
    ...
    private addHeader(): void {
        ...
        // Title bar - BeamLab Ultimate branding
        ...
        this.doc.text('BeamLab Ultimate', this.margin, 16);

        // Report title on right
        this.doc.setFontSize(11);
        this.doc.setFont('helvetica', 'normal');
        this.doc.text('Structural Analysis Report', this.pageWidth - this.margin, 12, { align: 'right' });
        this.doc.setFontSize(9);
        this.doc.text('beamlabultimate.tech', this.pageWidth - this.margin, 20, { align: 'right' });
    ...
    private addFooter(): void {
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            this.doc.text(
                `© ${year} BeamLab Ultimate | beamlabultimate.tech`,
                this.margin,
                this.pageHeight - 12
            );
            this.doc.text(
