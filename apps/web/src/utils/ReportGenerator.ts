...
export class ReportGenerator {
    ...
    private addHeader(): void {
        ...
        try {
            ...
            this.doc.addImage(LOGO_BASE64, 'JPEG', this.margin, 5, 20, 20);
        } catch (e) {
        ...
        this.doc.text('BeamLab Ultimate', this.margin + 25, 18); // Shifted text right for logo

        this.doc.setFontSize(10);
        this.doc.setFont('helvetica', 'normal');
        this.doc.text('Advanced AI-Powered Structural Analysis', this.margin, 25);
        ...
        this.doc.setFont('helvetica', 'normal');
        this.doc.text('Generated by beamlabultimate.tech', this.pageWidth - this.margin, 22, { align: 'right' });
