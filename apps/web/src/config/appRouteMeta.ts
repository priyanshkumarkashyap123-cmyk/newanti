...
export const APP_FEATURE_CATEGORIES: AppFeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'design-tools', label: 'Design Tools Finder', path: '/design/tools', description: 'Unified design tool discovery experience', iconKey: 'compass', category: 'design', badge: 'New' },
      ...
      { id: 'moving-load', label: 'Moving Load Analysis', path: '/design/moving-load', description: 'Bridge moving load analysis workflows', iconKey: 'activity', category: 'design', badge: 'New' },
      { id: 'torsion-design', label: 'Torsion Design', path: '/design/torsion', description: 'Beam/section torsional design checks', iconKey: 'workflow', category: 'design', badge: 'New' },
      { id: 'retaining-wall-design', label: 'Retaining Wall Design', path: '/design/retaining-wall', description: 'Retaining wall design and stability checks', iconKey: 'mountain', category: 'design', badge: 'New' },
      { id: 'staircase-design', label: 'Staircase Design', path: '/design/staircase', description: 'Staircase geometry and reinforcement design', iconKey: 'columns', category: 'design', badge: 'New' },
      ...
      { id: 'advanced-structures', label: 'Advanced Structures', path: '/design/advanced-structures', description: 'Deep beam, built-up steel, industrial roof, bridge and aqueduct workflows', iconKey: 'activity', category: 'design', badge: 'New' },
