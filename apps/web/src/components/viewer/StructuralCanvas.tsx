...
import { CameraFitController } from "./CameraFitController";
...
// console.log(
  ...
  return (
    <group>
      ...
      {useUltraLight ? <UltraLightNodesRenderer /> : <InstancedNodesRenderer />}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <pointLight
          position={[-10, 10, -10]}
          intensity={isLargeModel ? 0.2 : 0.3}
        />
        ...
        {/* Auto-fit camera to model extents */}
        <CameraFitController />
      ...
      <div className="sr-only" aria-live="polite">
        Keyboard shortcuts: R to reset view, Escape to deselect, Delete to
        remove selected
      </div>
    </div>
  );
