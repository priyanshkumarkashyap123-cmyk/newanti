...
export class CanvasErrorBoundary extends Component<SafeCanvasWrapperProps, ErrorBoundaryState> {
    ...
    override render() {
        ...
        if (hasError) {
            ...
            return (
                <div className="flex flex-col items-center justify-center h-full bg-[#0b1326] text-[#dae2fd] p-8">
                    <div className="max-w-lg text-center">
                        ...
                        {error && (
                            <details className="mt-6 text-left">
                                ...
                                <pre className="mt-2 p-4 bg-[#131b2e] rounded text-xs overflow-auto max-h-40">
                                    {error.message}
                                </pre>
                            </details>
                        )}
    ...
    return (
        <div className={`fixed top-4 right-4 z-50 max-w-sm p-4 rounded-lg shadow-lg ${
            ...
            <div className="flex justify-between items-start">
                <div>
                    <h4 className="font-bold text-[#dae2fd] flex items-center gap-2">
                    ...
                    <p className="text-xs text-[#869ab8] mt-2">{recommendation}</p>
                    {memoryStatus !== 'ok' && (
