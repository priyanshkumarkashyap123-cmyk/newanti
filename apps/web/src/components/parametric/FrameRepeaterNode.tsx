        ...
        >
            ...
            <div className="p-3 space-y-3">
                ...
                <div className="flex items-center gap-2">
                    <span className="text-[#869ab8] text-xs">Input</span>
                ...
                {/* Count */}
                <div className="flex items-center gap-2">
                    <label className="text-[#869ab8] text-xs w-16">Count</label>
                    <input
                        type="number"
                        ...
                        className="flex-1 px-2 py-1 bg-slate-200 dark:bg-slate-700 text-[#dae2fd] text-sm rounded border border-slate-600 focus:border-orange-500 focus:outline-none"
                    />
                </div>

                {/* Spacing */}
                <div className="flex items-center gap-2">
                    <label className="text-[#869ab8] text-xs w-16">Spacing</label>
                    <input
                        type="number"
                ...
                {/* Direction */}
                <div className="flex items-center gap-2">
                    <label className="text-[#869ab8] text-xs w-16">Direction</label>
            ...
            {/* Output Labels */}
            <div className="absolute right-4 text-[#869ab8] text-[10px]" style={{ top: '38%' }}>Nodes</div>
            <div className="absolute right-4 text-[#869ab8] text-[10px]" style={{ top: '58%' }}>Members</div>
        </div>
    );
};
