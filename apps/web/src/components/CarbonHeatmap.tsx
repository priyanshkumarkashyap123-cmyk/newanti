    ...
    return (
        <div className={`bg-slate-100 dark:bg-slate-800 rounded-xl p-5 ${className}`}>
            ...
            <div className="mt-4 p-3 bg-slate-700/30 rounded-lg">
                <div className="text-gray-500 dark:text-gray-400 text-xs uppercase mb-2">Equivalent To</div>
                ...
                {sortedMaterials.map(([material, data]) => (
                    <div key={material} className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="text-gray-600 dark:text-gray-300 text-sm capitalize">{material}</span>
                        </div>
...
export const CarbonLegend: FC<CarbonLegendProps> = ({ minValue, maxValue }) => {
    return (
        <div className="bg-slate-100/90 dark:bg-slate-800/90 rounded-lg p-3 inline-flex flex-col items-center">
            <div className="text-gray-500 dark:text-gray-400 text-xs uppercase mb-2">Carbon Intensity</div>
            ...
            <div className="flex justify-between w-32 mt-1">
                <span className="text-gray-500 dark:text-gray-400 text-xs">{minValue.toFixed(0)}</span>
                <span className="text-gray-500 dark:text-gray-400 text-xs">{maxValue.toFixed(0)} kgCO₂e</span>
            </div>
        </div>
    );
};
