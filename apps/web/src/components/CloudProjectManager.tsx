    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="max-w-3xl max-h-[80vh] flex flex-col overflow-hidden p-0">
                ...
                {/* Header */}
                <DialogHeader className="px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 flex-shrink-0">
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-zinc-50 dark:bg-zinc-950/50">
                    {isLoading && projects.length === 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-60 text-zinc-500 dark:text-zinc-400 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-xl">
                                        ...
                                        <div className="flex items-center gap-1">
                                            {deleteId === project._id ? (
                                                ...
                                                <button
                                                    ...
                                                    className="p-1.5 text-zinc-500 dark:text-zinc-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors"
