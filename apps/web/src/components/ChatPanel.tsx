        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed right-0 top-0 bottom-0 w-96 bg-white shadow-2xl z-50 flex flex-col border-l border-gray-200"
                >
                    {/* Header */}
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                        {messages.length === 0 && (
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-gray-900 font-semibold mb-2">AI Engineering Assistant</h3>
                        ...
                        {messages.map((message) => (
                            ...
                            >
                                <div className={`max-w-[85%] ${message.role === 'user' ? 'order-2' : 'order-1'}`}>
                                                    ...
                                                    {message.suggestions.map((suggestion) => (
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <ChevronDown className={`w-4 h-4 text-gray-400 transition-transform ${expandedSuggestion === suggestion.id ? 'rotate-180' : ''
                                                                    }`} />
                                                            </button>
                                                                    ...
                                                                    >
                                                                        <div className="p-3 space-y-3 text-sm">
                                                                            ...
                                                                            <div className="bg-blue-50 rounded p-2">
                                                                                <div className="text-xs font-medium text-blue-700 mb-1">Implementation:</div>
                                                                                <p className="text-blue-800">{suggestion.implementation}</p>
                                                                            </div>
                                    ...
                                    {/* Timestamp */}
                                    <div className={`text-xs text-gray-400 mt-1 ${message.role === 'user' ? 'text-right' : 'text-left ml-10'}`}>
