    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed right-0 top-0 bottom-0 w-96 bg-zinc-900/95 backdrop-blur-xl border-l border-white/10 z-50 flex flex-col"
        >
          {/* Header */}
...
const Viewport3D: React.FC<{ 
  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-2xl overflow-hidden">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="absolute top-4 left-4 px-3 py-1.5 bg-black/50 backdrop-blur-sm rounded-lg border border-white/10">
            <span className="text-xs font-medium text-white">{viewMode} View</span>
          </div>
          ...
          <div className="absolute bottom-4 left-4 flex items-center gap-2 px-3 py-1.5 bg-black/50 backdrop-blur-sm rounded-lg border border-white/10">
            ...
            <span className="text-xs text-white/70">5m</span>
          </div>
...
const AnalysisControlPanel: React.FC<{
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-sm font-semibold text-white">Analysis Types</h3>
  ...
  return (
    <div className="h-screen w-screen bg-zinc-950 text-white overflow-hidden flex flex-col">
      ...
      <motion.header 
        ...
        className="h-14 bg-zinc-900/80 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-4 z-40"
      >
        {/* Logo & Project */}
        ...
        {/* Mode Tabs */}
        <nav className="flex items-center gap-1 p-1 bg-zinc-800/50 rounded-xl">
          {[
        ...
        <div className="flex items-center gap-2">
          ...
          <button aria-label="Notifications" title="Notifications" className="p-2.5 rounded-xl bg-zinc-800 text-zinc-400 hover:text-white hover:bg-zinc-700 transition-colors">
            <Bell className="w-5 h-5" />
          </button>
          
          <button aria-label="Share" title="Share" className="p-2.5 rounded-xl bg-zinc-800 text-zinc-400 hover:text-white hover:bg-zinc-700 transition-colors">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <motion.aside 
          ...
          className="w-14 bg-zinc-900/50 border-r border-white/5 flex flex-col items-center py-3 gap-2"
        >
          {[
        ...
        <main className="flex-1 p-3 relative">
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 p-2 bg-black/50 backdrop-blur-xl rounded-2xl border border-white/10">
            ...
            <button className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-zinc-800 text-zinc-300 hover:bg-zinc-700 text-sm font-medium transition-colors">
            ...
            <button 
              ...
              className="p-2.5 rounded-xl bg-zinc-800 text-zinc-300 hover:bg-zinc-700 transition-colors"
            >
        ...
        <motion.aside 
          ...
          className="w-80 bg-zinc-900/50 border-l border-white/5 flex flex-col"
        >
          ...
          <div className="p-4 border-b border-white/5">
            ...
            <div className="relative">
              <select 
                ...
                className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-xl text-white appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
              >
                {DESIGN_CODES.map(c => (
