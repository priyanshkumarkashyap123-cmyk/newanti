  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-2xl border p-4 bg-gradient-to-br ${
        status
          ? statusColors[status]
          : "from-slate-100/50 dark:from-slate-800/50 to-slate-50/50 dark:to-slate-900/50 border-slate-200/50 dark:border-slate-700/50"
      }`}
    >
          ...
          <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
            {sortedMembers.map((member, index) => (
              <motion.tr
                ...
                className={`hover:bg-slate-200/50 dark:hover:bg-slate-800/50 cursor-pointer transition-colors ${
    ...
    <div className={`bg-[#0b1326] p-6 space-y-6 ${className}`}>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button type="button" className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl transition-colors">
