...
export const PageFooter: FC = () => {
  ...
  return (
    <footer className="border-t border-[#1a2333] bg-[#0b1326]">
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#869ab8]">
        ...
        <div className="flex items-center flex-wrap justify-center gap-x-3 gap-y-1">
          ...
          <Link to="/support" className="hover:text-slate-700 dark:hover:text-slate-200 transition-colors">Support</Link>
          <Link to="/contact" className="hover:text-slate-700 dark:hover:text-slate-200 transition-colors">Contact</Link>
          <Link to="/trust" className="hover:text-slate-700 dark:hover:text-slate-200 transition-colors">Trust</Link>
          <Link to="/privacy-policy" className="hover:text-slate-700 dark:hover:text-slate-200 transition-colors">Privacy</Link>
          <Link to="/terms-and-conditions" className="hover:text-slate-700 dark:hover:text-slate-200 transition-colors">Terms</Link>
        </div>
      </div>
    </footer>
  );
