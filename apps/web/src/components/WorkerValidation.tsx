...
export function WorkerValidation() {
    ...
    return (
        <div className="p-4 bg-[#0b1326] text-[#dae2fd] font-mono rounded-lg shadow-lg max-w-2xl text-sm">
            ...
            <div className="border border-slate-700 bg-white dark:bg-black p-2 h-64 overflow-y-auto whitespace-pre-wrap">
