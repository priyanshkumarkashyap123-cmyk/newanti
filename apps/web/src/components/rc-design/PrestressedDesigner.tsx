    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 dark:from-slate-900 via-purple-100 dark:via-purple-900 to-slate-50 dark:to-slate-900 p-6">
          ...
          <button type="button"
            ...
            className={`px-6 py-3 rounded-xl font-medium transition-all ${
              activeTab === tab
                ...
                : 'bg-slate-100/50 dark:bg-slate-800/50 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-slate-700/50'
            }`}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <button type="button"
                          ...
                          className={`p-3 rounded-xl text-sm transition-all ${
                            form.prestressType === type
                              ...
                              : 'bg-slate-200/50 dark:bg-slate-700/50 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
                          }`}
                        >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-3 rounded-xl bg-slate-200/50 dark:bg-slate-700/50 text-slate-900 dark:text-white border border-white/10 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20"
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 rounded-xl bg-slate-200/50 dark:bg-slate-700/50 text-slate-900 dark:text-white border border-white/10 focus:border-blue-500"
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 rounded-xl bg-slate-200/50 dark:bg-slate-700/50 text-slate-900 dark:text-white border border-white/10 focus:border-amber-500"
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-3 rounded-xl bg-slate-200/50 dark:bg-slate-700/50 text-slate-900 dark:text-white border border-white/10 focus:border-pink-500"
                    >
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          step={0.01}
                          className="w-full p-2 rounded-lg bg-slate-200/50 dark:bg-slate-700/50 text-slate-900 dark:text-white border border-white/10 text-sm"
                        />
                      </div>
                      <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 rounded-xl bg-slate-200/50 dark:bg-slate-700/50 text-slate-900 dark:text-white border border-white/10 focus:border-green-500"
                    />
                    <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              ...
              <div className="flex gap-4">
                <motion.button
                  ...
                  className="flex-1 py-4 rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 text-slate-900 dark:text-white font-semibold text-lg shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 transition-shadow"
                >
                  🚀 Calculate Design
                </motion.button>
                <motion.button
        ...
        <div className="space-y-6">
          {/* Section Preview */}
          <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Section Preview</h3>
            <SectionPreview form={form} />
          </div>

          {/* Tendon Profile Preview */}
          <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Tendon Profile</h3>
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-900 dark:text-white font-medium">{result.losses.effectiveForce.toFixed(0)} kN</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500 dark:text-slate-400">Total Loss:</span>
                  <span className="text-slate-900 dark:text-white font-medium">{result.losses.totalPercentLoss.toFixed(1)}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500 dark:text-slate-400">φMn:</span>
                  <span className="text-slate-900 dark:text-white font-medium">{result.ultimateCapacity.phiMn.toFixed(0)} kN-m</span>
                </div>
              </div>
            </motion.div>
          )}
...
const ResultsPanel: React.FC<{ result: PrestressedDesignResult }> = ({ result }) => {
  return (
    <div className="space-y-6">
      {/* Ultimate Capacity */}
      <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
        <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Ultimate Moment Capacity</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      {/* Shear Design */}
      <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
        <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Shear Design</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      {/* Deflection */}
      <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
        <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Deflection</h3>
...
const LossesPanel: React.FC<{ result: PrestressedDesignResult }> = ({ result }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Loss Summary */}
      <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
        <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Prestress Losses Summary</h3>
      ...
      {/* Loss Breakdown */}
      <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
        <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Loss Breakdown</h3>
          ...
          {lossData.map((item, idx) => (
            <div key={idx}>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-slate-900 dark:text-white font-medium">{item.value.toFixed(1)} MPa</span>
              </div>
        ...
        <div className="bg-purple-500/10 border border-purple-500/30 rounded-2xl p-6">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-slate-900 dark:text-white">{losses.immediate.elasticShortening.toFixed(1)} MPa</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500 dark:text-slate-400">Anchorage Slip:</span>
              <span className="text-slate-900 dark:text-white">{losses.immediate.anchorageSlip.toFixed(1)} MPa</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500 dark:text-slate-400">Friction:</span>
              <span className="text-slate-900 dark:text-white">{losses.immediate.frictionLoss.toFixed(1)} MPa</span>
            </div>
        ...
        <div className="bg-pink-500/10 border border-pink-500/30 rounded-2xl p-6">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-slate-900 dark:text-white">{losses.timeDependent.creep.toFixed(1)} MPa</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500 dark:text-slate-400">Shrinkage:</span>
              <span className="text-slate-900 dark:text-white">{losses.timeDependent.shrinkage.toFixed(1)} MPa</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-500 dark:text-slate-400">Relaxation:</span>
              <span className="text-slate-900 dark:text-white">{losses.timeDependent.relaxation.toFixed(1)} MPa</span>
            </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold text-slate-900 dark:text-white">Stresses at Transfer</h3>
          <div className={`px-4 py-2 rounded-full text-sm font-medium ${
      ...
      <div className="bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold text-slate-900 dark:text-white">Stresses at Service</h3>
          <div className={`px-4 py-2 rounded-full text-sm font-medium ${
      ...
      <div className="space-y-1">
        {data.map((item, idx) => (
          <div key={idx} className="flex items-center gap-2 text-xs">
            ...
            <span className="text-slate-900 dark:text-white">{((item.value / total) * 100).toFixed(1)}%</span>
          </div>
        ))}
      </div>
    </div>
