    ...
    return (
        <div className="bg-gray-900 rounded-xl border border-gray-700 overflow-hidden">
            <div className="px-4 py-3 bg-gray-800 border-b border-gray-700 flex items-center gap-2">
                ...
                <h3 className="font-semibold text-white">Sketch to Model</h3>
            </div>
            ...
            <div className="p-4">
                {status === 'idle' && (
                    ...
                    >
                        ...
                        <p className="text-gray-400 mb-2">Drop a sketch image or click to upload</p>
                ...
                {status === 'processing' && (
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-400">Analyzing sketch with AI...</p>
                ...
                {status === 'complete' && result && (
                    <div>
                        ...
                        <div className="grid grid-cols-4 gap-3 mb-4">
                            ...
                            <div className="bg-gray-800 rounded-lg p-3 text-center">
                                <div className="text-2xl font-bold text-white">{result.members.length}</div>
                                <div className="text-gray-400 text-sm">Members</div>
                            </div>
                            <div className="bg-gray-800 rounded-lg p-3 text-center">
                                <div className="text-2xl font-bold text-white">{result.nodes.filter(n => n.isSupport).length}</div>
                                <div className="text-gray-400 text-sm">Supports</div>
                            </div>
                            <div className="bg-gray-800 rounded-lg p-3 text-center">
                                <div className="text-2xl font-bold text-white">{result.loads.length}</div>
                                <div className="text-gray-400 text-sm">Loads</div>
                            </div>
                        </div>

                        <div className="bg-gray-800 rounded-lg p-3 mb-4">
                            <div className="flex items-center justify-between">
                                <span className="text-gray-400">Detected Structure</span>
                                <span className="text-white font-medium capitalize">{result.structureType}</span>
                            </div>
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="flex-1 py-2 bg-violet-600 text-white rounded-lg hover:bg-violet-500 font-medium"
                            >
                                Create Model
                            </button>
                            <button
