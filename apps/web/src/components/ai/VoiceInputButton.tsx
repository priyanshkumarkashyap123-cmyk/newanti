    ...
    return (
        <div className="relative">
            ...
            {showFeedback && lastCommand && (
                <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 whitespace-nowrap bg-gray-800 text-white text-sm px-3 py-1 rounded-lg shadow-lg">
                    "{lastCommand}"
                </div>
            )}
        </div>
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-700 overflow-hidden">
            <div className="px-4 py-3 bg-gray-800 border-b border-gray-700 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-white">Voice Commands</span>
                    {state.isListening && (
            ...
            <div className="p-4">
                {/* Quick commands */}
                <div className="mb-4">
                    <h4 className="text-gray-400 text-sm mb-2">Try saying:</h4>
                ...
                {/* Command history */}
                <div>
                    <h4 className="text-gray-400 text-sm mb-2">Recent Commands</h4>
