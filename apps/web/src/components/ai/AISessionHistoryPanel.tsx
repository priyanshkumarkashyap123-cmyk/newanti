...
const SessionCard: FC<{
  ...
  return (
    <div className="bg-slate-100/50 dark:bg-slate-800/50 border border-slate-200/50 dark:border-slate-700/50 rounded-lg overflow-hidden hover:border-slate-600/50 transition-colors">
      {/* Header */}
      <div
      ...
      {isExpanded && (
        <div className="border-t border-slate-200/50 dark:border-slate-700/50 px-3 py-2 space-y-1.5 max-h-48 overflow-y-auto">
          {session.messages.length === 0 ? (
            <p className="text-[10px] text-slate-500 italic">Empty session</p>
          ) : (
      ...
      <div className="px-3 py-3 border-b border-[#1a2333]">
        ...
        <div className="mt-2 relative">
          ...
          {searchQuery && (
            ...
            >
              <X className="w-3 h-3 text-slate-500 hover:text-slate-600 dark:hover:text-slate-300" />
            </button>
          )}
        </div>
            ...
            <button type="button"
              ...
              className={`flex items-center gap-1 px-2 py-1 text-[10px] rounded transition-colors ${
                filterType === type
                  ...
                  : 'text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 hover:bg-slate-200/50 dark:hover:bg-slate-700/50'
              }`}
            >
              {type === 'all' && 'All'}
