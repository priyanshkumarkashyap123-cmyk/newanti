...
const ColorLegend: FC<ColorLegendProps> = ({ minVal, maxVal, unit, colorScale, label }) => {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            {/* Color bar */}
            <div 
                className="h-4 rounded-full overflow-hidden border border-zinc-700"
                style={{
        ...
        <div className="bg-zinc-900 rounded-xl border border-zinc-800 overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-zinc-800/50 border-b border-zinc-800">
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={toggleSort}
                        className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm text-zinc-400 hover:text-white hover:bg-zinc-700 transition-colors"
                    >
