...
export const ResultsToolbar: FC<ResultsToolbarProps> = React.memo(({ onClose }) => {
  ...
  const executePDFExport = async () => {
    ...
    try {
      ...
      report.addProjectInfo({
        projectName: "BeamLab Analysis",
        description:
          "Structural analysis results generated by BeamLab",
      });
  ...
  return (
    <>
      <div className="fixed bottom-4 right-4 z-40 w-80 bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
        {/* Header */}
