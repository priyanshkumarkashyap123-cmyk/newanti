        ...
        <group>
            ...
            {hovered && (
                <Html
                    ...
                    style={{ pointerEvents: 'none' }}
                >
                    <div className="bg-black/90 text-[#dae2fd] text-xs px-2 py-1 rounded whitespace-nowrap">
            ...
            <div className="flex gap-1 mb-2">
                ...
                <div className="flex-1 flex flex-col justify-between text-right">
                    {intervals.filter((_, i) => i % 2 === 0).reverse().map((interval, idx) => (
                        <div key={idx} className="text-xs font-mono text-[#869ab8]">
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <ChevronDown size={14} className={`text-[#869ab8] transition-transform ${isOpen ? 'rotate-180' : ''}`} />
            </button>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -8 }}
                            className="absolute left-0 top-full mt-1 w-64 bg-[#131b2e] border border-[#1a2333] 
                                ...
                                >
                                    <div className="mt-0.5">
                                        {selected === type.id ? (
                                            ...
                                            <EyeOff size={14} className="text-[#869ab8]" />
                                        )}
                                    </div>
                                    <div>
            ...
            >
                ...
                <div style={{
                    ...
                    <div className="bg-slate-50/95 dark:bg-slate-900/95 backdrop-blur-md rounded-xl border border-slate-300/60 dark:border-slate-700/60 shadow-2xl p-3 w-[200px]">
                        {/* Stress type selector */}
                        <div className="mb-3">
                            <div className="text-[10px] uppercase tracking-wider text-[#869ab8] font-semibold mb-1.5">Stress Type</div>
                            <select
                                value={stressType}
                                onChange={(e) => onStressTypeChange(e.target.value as StressType)}
                                className="w-full text-xs bg-[#131b2e] border border-slate-600 text-slate-700 dark:text-slate-200 rounded-md px-2 py-1.5 cursor-pointer focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500"
                            >
                                {STRESS_TYPES.map(st => (
                        ...
                        {/* Color bar + scale */}
                        <div className="text-[10px] uppercase tracking-wider text-[#869ab8] font-semibold mb-1.5">
                        ...
                        <div className="mt-3 pt-2 border-t border-slate-300/60 dark:border-slate-700/60 space-y-1">
                            ...
                            <div className="flex justify-between text-[10px]">
                                <span className="text-[#869ab8]">Critical ({'>'} 100%)</span>
                            ...
                            {allowableStress > 0 && (
                                <div className="flex justify-between text-[10px]">
                                    <span className="text-[#869ab8]">f_y (yield)</span>
    ...
    return (
        <div className="bg-[#0b1326] rounded-xl border border-[#1a2333] overflow-hidden">
            ...
            <div className="p-4 space-y-4">
                ...
                {/* Summary */}
                <div className="pt-3 border-t border-[#1a2333] grid grid-cols-2 gap-4">
                    <div>
                        <div className="text-xs text-[#869ab8]">Stress Range</div>
                        <div className="text-sm font-mono">
                            ...
                            <span className="text-[#869ab8]"> MPa</span>
                        </div>
                    </div>
                    
                    <div>
                        <div className="text-xs text-[#869ab8]">Critical Members</div>
