...
const ViewportContainer: FC<{
  ...
  if (layout === "SINGLE") {
    return (
      ...
      >
        <div
          className="absolute top-2 left-2 text-white z-10 text-[11px] opacity-80 font-medium tracking-wide"
        >
          ...
          >
            ...
            <div className="flex gap-1">
              <button type="button"
                ...
                className="flex-1 text-white rounded p-1.5 cursor-pointer text-[11px] font-medium tracking-wide"
                style={{
                  background:
                    layout === "SINGLE"
                      ? "#007bff"
