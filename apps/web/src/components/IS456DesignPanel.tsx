...
export const IS456DesignPanel: FC<IS456DesignPanelProps> = ({
  ...
  return (
    <div className="bg-zinc-900 rounded-xl overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-white/20 text-white rounded-md text-sm font-medium hover:bg-white/30 disabled:opacity-50 border border-white/30"
      ...
      <div className="px-4 py-3 bg-zinc-800/60 border-b border-zinc-700 flex items-center justify-between gap-4">
        ...
        <div className="border-b border-zinc-700">
          ...
          <div className="max-h-48 overflow-y-auto divide-y divide-zinc-800">
            {Array.from(smartResults.entries()).map(([memberId, result]) => (
              <div
                key={memberId}
                className="px-4 py-2 flex items-center justify-between text-sm hover:bg-zinc-800/30"
              >
                <span className="text-zinc-300 font-medium">{memberId}</span>
