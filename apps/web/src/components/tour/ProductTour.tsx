    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100]">
        ...
        <motion.div
          ...
          exit={{ opacity: 0, y: 20 }}
          className={`absolute bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl max-w-md p-6 ${
            highlightRect 
        ...
        >
          ...
          <p className="text-slate-400 text-center mb-4 leading-relaxed">
            {step.description}
          </p>
