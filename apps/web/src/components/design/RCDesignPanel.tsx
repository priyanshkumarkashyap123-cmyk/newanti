            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4 bg-zinc-800/50 p-6 rounded-xl border border-zinc-700">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-zinc-400 mb-1">Width (mm)</label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-sm text-zinc-400 mb-1">Depth (mm)</label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-sm text-zinc-400 mb-1">Shear (kN)</label>
                            <input
                                type="number"
                    ...
                    {result ? (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-sm font-medium text-zinc-400">Reinforcement Details</h4>
                            ...
                            <div className="space-y-2">
                                <h4 className="text-sm font-medium text-zinc-400">Checks</h4>
                                <div className="space-y-1">
                                    {result.checks.map((check, i) => (
                                        <div key={i} className="text-xs text-zinc-400 p-2 bg-zinc-900/50 rounded border border-zinc-800 flex justify-between items-center">
                                            <span>{check.name}</span>
                                            <div className="text-right">
                                                <div className="text-white">{check.demand.toFixed(1)} / {check.capacity.toFixed(1)} {check.unit}</div>
