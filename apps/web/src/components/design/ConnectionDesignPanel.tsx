        ...
        <div className="space-y-6 p-6 bg-white dark:bg-slate-900 min-h-screen text-slate-900 dark:text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4 bg-slate-100/50 dark:bg-slate-800/50 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                    ...
                    <div>
                        <label className="block text-sm text-slate-500 dark:text-slate-400 mb-1">Connection Type</label>
                        <select
                            value={connType}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-slate-500 dark:text-slate-400 mb-1">Shear Load (kN)</label>
                            <input
                                type="number"
                        ...
                        {(connType !== 'base_plate') && (
                            <div>
                                <label className="block text-sm text-slate-500 dark:text-slate-400 mb-1">Beam Depth (mm)</label>
                                <input
                                    type="number"
                        ...
                        {(connType === 'base_plate') && (
                            <>
                                <div>
                                    <label className="block text-sm text-slate-500 dark:text-slate-400 mb-1">Plate Width (mm)</label>
                                    <input
                                        type="number"
                                ...
                                <div>
                                    <label className="block text-sm text-slate-500 dark:text-slate-400 mb-1">Plate Length (mm)</label>
                                    <input
                                        type="number"
                        ...
                        <div>
                            <label className="block text-sm text-slate-500 dark:text-slate-400 mb-1">Bolt Dia (mm)</label>
                            <select
                ...
                <div className="bg-slate-100/50 dark:bg-slate-800/50 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                    ...
                    {result ? (
                        <div className="space-y-4">
                            <div className="p-3 bg-white dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-700 text-sm font-mono whitespace-pre-wrap">
                                {result.connection}
                            </div>
                            ...
                            <div className="space-y-1">
                                <h4 className="text-sm font-medium text-slate-500 dark:text-slate-400">Detailed Checks</h4>
                                {result.checks.map((check, i) => (
                                    <div key={i} className="text-xs text-slate-500 dark:text-slate-400 p-2 bg-white/50 dark:bg-slate-900/50 rounded border border-slate-200 dark:border-slate-800">
                                        {check}
                                    </div>
                                ))}
                            </div>
