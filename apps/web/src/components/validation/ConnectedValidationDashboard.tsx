        ...
        <div className="h-full flex flex-col bg-[#0b1326] text-slate-700 dark:text-slate-200">
            ...
            <div className="p-4 border-b border-[#1a2333] flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-sm font-bold text-[#dae2fd]">Live Validation</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            <div className="p-4 bg-[#0b1326] rounded-lg border border-[#1a2333] text-center">
                                ...
                                <div className="text-xs text-[#869ab8]">Tests</div>
                            </div>
                        ...
                        {analysisResults && (
                            <div className="p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
                                ...
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    <div>
                                        <div className="text-lg font-mono text-[#dae2fd]">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[10px] text-[#869ab8]">Max Stress</div>
                                    </div>
                                    <div>
                                        <div className="text-lg font-mono text-[#dae2fd]">
                                            {analysisResults.utilizationMax?.toFixed(2) || 'N/A'}
                                        </div>
                                        <div className="text-[10px] text-[#869ab8]">Utilization</div>
                                    </div>
                                </div>
                            </div>
                        )}
