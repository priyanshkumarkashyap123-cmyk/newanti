        ...
        <div className="h-full flex flex-col bg-white dark:bg-zinc-950 text-zinc-700 dark:text-zinc-200">
            ...
            <div className="p-4 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-sm font-bold text-zinc-900 dark:text-white">Validation Dashboard</h2>
                        <p className="text-xs text-zinc-500 dark:text-zinc-400">Benchmark AI accuracy against analytical solutions</p>
                    </div>
                </div>
                <button
                ...
                {!report ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            <div className="p-4 bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 text-center">
                                <div className="text-2xl font-bold text-zinc-900 dark:text-white">{report.totalTests}</div>
                                <div className="text-xs text-zinc-500 dark:text-zinc-400">Total Tests</div>
                            </div>
                            <div className="p-4 bg-white dark:bg-zinc-900 rounded-lg border border-green-500/20 text-center">
                                <div className="text-2xl font-bold text-green-400">{report.passed}</div>
                                <div className="text-xs text-zinc-500 dark:text-zinc-400">Passed</div>
                            </div>
                            <div className="p-4 bg-white dark:bg-zinc-900 rounded-lg border border-red-500/20 text-center">
                            ...
                            <div className="p-4 bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 text-center">
                                ...
                                <div className="text-xs text-zinc-500 dark:text-zinc-400">Pass Rate</div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800">
                            ...
                            <div className="grid grid-cols-4 gap-4 text-center">
                                <div>
                                    ...
                                    <div className="text-[10px] text-zinc-500 dark:text-zinc-400">RMSE</div>
                                </div>
                                <div>
                                    <div className="text-lg font-mono text-purple-400">
                                        {report.overallAccuracy.maxErrorPercent.toFixed(2)}%
                                    </div>
                                    <div className="text-[10px] text-zinc-500 dark:text-zinc-400">Max Error</div>
                                </div>
                                <div>
                                    <div className="text-lg font-mono text-cyan-400">
                                        {report.overallAccuracy.meanError.toFixed(4)}
                                    </div>
                                    <div className="text-[10px] text-zinc-500 dark:text-zinc-400">Mean Error</div>
                                </div>
                                <div>
                                    <div className="text-lg font-mono text-green-400">
                                        {(report.overallAccuracy.r2 * 100).toFixed(2)}%
                                    </div>
                                    <div className="text-[10px] text-zinc-500 dark:text-zinc-400">R²</div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="text-right">
                                            <div className="text-xs font-mono">
                                                ...
                                                <span className="text-zinc-900 dark:text-white">{result.expected.toFixed(3)}</span>
                                            </div>
                                            <div className="text-xs font-mono">
