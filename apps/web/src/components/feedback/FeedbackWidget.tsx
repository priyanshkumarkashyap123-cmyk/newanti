      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed ${positionClasses} z-50 w-96 max-w-[calc(100vw-3rem)] bg-[#0b1326] border border-[#1a2333] rounded-2xl shadow-2xl overflow-hidden`}
          >
            {/* Header */}
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#1a2333]">
              ...
              <button type="button"
                onClick={handleClose}
                className="p-1.5 text-[#869ab8] hover:text-slate-900 dark:hover:text-white rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {feedbackTypes.map((type) => (
                    <button type="button"
                      ...
                      className="flex flex-col items-center gap-3 p-4 rounded-xl border border-[#1a2333] hover:border-blue-500/50 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 transition-all group"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-28 px-4 py-3 bg-[#131b2e] border border-[#1a2333] rounded-xl text-[#dae2fd] placeholder:text-slate-400 focus:outline-none focus:border-blue-500 resize-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-[#131b2e] border border-[#1a2333] rounded-xl text-[#dae2fd] placeholder:text-slate-400 focus:outline-none focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    <button type="button"
                      ...
                      className="flex-1 py-2.5 rounded-xl border border-[#1a2333] text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors"
                    >
                      Back
                    </button>
                    <button type="button"
              ...
              {step === 'success' && (
                <div className="text-center py-6">
                  ...
                  <h4 className="text-lg font-semibold text-[#dae2fd] mb-2">
                    Feedback Received!
                  </h4>
