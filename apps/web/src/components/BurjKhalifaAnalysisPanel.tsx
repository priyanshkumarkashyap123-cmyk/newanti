...
export const BurjKhalifaAnalysisPanel: FC<BurjAnalysisPanelProps> = ({ onClose }) => {
    ...
    // ============================================
    // LOAD VISUALIZATION CARD
    // ============================================

    const LoadCard: FC<{ title: string; value: number; unit: string; icon: any; color: string }> = 
    ...
    const CriticalElementsTable: FC = () => (
    ...
    const AnalysisStepsAccordion: FC = () => (
    ...
    return (
        <div className="flex flex-col h-full bg-white dark:bg-gray-950">
            ...
            <div className="flex-1 overflow-auto p-4 space-y-4">
                ...
                {activeTab === 'loads' && <AnalysisStepsAccordion />}
