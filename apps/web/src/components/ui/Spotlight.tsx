        ...
        <AnimatePresence>
            ...
            >
                ...
                <motion.div
                    ...
                    className="fixed w-80 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl overflow-hidden z-[1000]"
                    style={tooltipStyle}
                >
                    {/* Header */}
            ...
            <AnimatePresence>
                {isVisible && (
                    <motion.div
                        ...
                        className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg shadow-xl z-50 whitespace-nowrap"
                    >
