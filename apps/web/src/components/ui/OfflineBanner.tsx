        ...
        <AnimatePresence>
                ...
                >
                    <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="flex items-center gap-2 text-sm font-medium tracking-wide truncate">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            ...
                            <button type="button"
                                onClick={handleRetry}
                                disabled={isSyncing}
                                className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium tracking-wide rounded-md bg-amber-700/20 hover:bg-amber-700/30 active:scale-[0.97] transition-all disabled:opacity-50"
                            >
                                <RefreshCw
            ...
            {showReconnected && isOnline && (
                <motion.div
                    ...
                    role="status"
                    aria-live="polite"
                    className="fixed top-4 left-1/2 z-[9999] -translate-x-1/2 bg-emerald-600 text-white rounded-lg shadow-xl px-4 py-2.5 flex items-center gap-2 text-sm font-medium tracking-wide"
