/**
 * Table Component - Data Table primitives
 *
 * Properly uses cn() for class merging, consistent slate palette,
 * full dark mode support, and accessible styling.
 */
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-[#1a2333] bg-slate-50/50 dark:bg-slate-800/30 font-medium tracking-wide [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
