    ...
    <div className="w-full h-full flex flex-col bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          {showSettings && (
            ...
            >
              <div className="p-4 space-y-6 w-[280px]">
                <div>
                  <h3 className="font-semibold text-slate-700 mb-3">Display Options</h3>
                ...
                <div>
                  <h3 className="font-semibold text-slate-700 mb-3">Diagrams</h3>
                  <div className="space-y-2">
                    {[
      ...
      {result && (
        <motion.div
          ...
          className="border-t bg-slate-50 p-3"
        >
          <div className="flex items-center justify-around text-sm">
            <div className="flex items-center gap-2">
              <span className="text-red-500 font-medium">Max Moment:</span>
              <span className="text-slate-700">{result.maxMoment.value.toFixed(2)} kNm @ {result.maxMoment.location}</span>
            </div>
            <div className="w-px h-4 bg-slate-300" />
            <div className="flex items-center gap-2">
              <span className="text-blue-500 font-medium">Max Shear:</span>
              <span className="text-slate-700">{result.maxShear.value.toFixed(2)} kN @ {result.maxShear.location}</span>
            </div>
            <div className="w-px h-4 bg-slate-300" />
            <div className="flex items-center gap-2">
              <span className="text-green-500 font-medium">Max Deflection:</span>
              <span className="text-slate-700">{result.maxDeflection.value.toFixed(3)} mm @ {result.maxDeflection.location}</span>
            </div>
          </div>
        </motion.div>
      )}
