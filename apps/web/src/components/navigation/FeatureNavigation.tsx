                            ...
                            {category.features.map((feature) => (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="text-[13px] font-medium tracking-wide text-[#dae2fd] flex items-center gap-2 flex-wrap group-hover:text-[#adc6ff] transition-colors">
                                    {feature.label}
                                    {feature.badge && (
                                  ...
                                  {feature.description && (
                                    <div className="text-[11px] font-medium tracking-wide text-[#8c909f] truncate mt-0.5">
                                      {feature.description}
                                    </div>
                                  )}
                                </div>
