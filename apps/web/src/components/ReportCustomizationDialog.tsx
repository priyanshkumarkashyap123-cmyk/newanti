                ...
                <div className="space-y-2">
                  {[
                    ...
                    >
                      ...
                      />
                      <div>
                        <div className="text-sm font-medium tracking-wide text-foreground">{section.label}</div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      >
                        ...
                        />
                        <div>
                          <div className="text-sm font-medium tracking-wide text-foreground">{diagram.label}</div>
                ...
                <div className="flex gap-2">
                  {(['PDF', 'DOCX', 'HTML'] as const).map(fmt => (
                    <button type="button"
                      ...
                      className={`px-5 py-2 rounded-lg font-medium tracking-wide text-sm transition-all ${
                ...
                <div className="flex gap-4">
                  {[
                    ...
                    >
                      ...
                      />
                      <span className="text-[10px] text-muted-foreground font-medium tracking-wide">{preset.name}</span>
                    </button>
                  ))}
                </div>
              </div>
