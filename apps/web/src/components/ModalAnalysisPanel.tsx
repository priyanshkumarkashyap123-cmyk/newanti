...
export const ModalAnalysisPanel: FC<ModalAnalysisPanelProps> = ({ isPro = false }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-white dark:bg-slate-900 text-slate-900 dark:text-white rounded-lg overflow-hidden">
            {/* Header */}
            <div className="p-3 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                ...
                <div className="flex items-center gap-3 text-xs">
                    <label className="flex items-center gap-2">
                        <span className="text-slate-500 dark:text-slate-400">Modes:</span>
                        <input
                            type="number"
                            min={1}
                            max={50}
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-3 gap-2 mb-4 text-center text-xs">
                            <div className="p-2 bg-slate-100 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700">
                                ...
                                <div className="text-slate-500 dark:text-slate-400">1st Freq (Hz)</div>
                            </div>
                            <div className="p-2 bg-slate-100 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700">
                                <div className="text-lg font-bold text-green-400">{modes[0]?.period.toFixed(3)}</div>
                                <div className="text-slate-500 dark:text-slate-400">1st Period (s)</div>
                            </div>
                            <div className="p-2 bg-slate-100 dark:bg-slate-800 rounded border border-slate-200 dark:border-slate-700">
                                <div className="text-lg font-bold text-slate-700 dark:text-slate-200">{modes.length}</div>
                                <div className="text-slate-500 dark:text-slate-400">Modes</div>
                            </div>
                        </div>

                        {viewMode === 'table' ? (
                            <div className="bg-slate-100 dark:bg-slate-800 rounded-lg overflow-hidden text-xs border border-slate-200 dark:border-slate-700">
            ...
            {/* Footer */}
            {modes.length > 0 && (
                <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex justify-between items-center text-xs">
