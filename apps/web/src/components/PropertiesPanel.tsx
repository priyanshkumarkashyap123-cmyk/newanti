...
const NumberInput: FC<NumberInputProps> = memo(({ value, onChange, step = 0.1, disabled, className }) => {
    ...
    return (
        <input
            ...
            disabled={disabled}
            className={`bg-[#131b2e] border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-slate-50 px-2 py-1.5 rounded text-xs w-full
    ...
    return (
        <div className="flex flex-col">
            ...
            >
                ...
                <span className="text-xs font-medium tracking-wide tracking-wide text-slate-600 group-hover:text-[#dae2fd] transition-colors">{label}</span>
            </button>
...
const PresetBtn: FC<{ label: string; active: boolean; onClick: () => void; title?: string }> = ({ label, active, onClick, title }) => (
    <button type="button"
        onClick={onClick}
        title={title}
        className={`flex-1 py-1 px-2 rounded text-[10px] font-medium tracking-wide tracking-wide transition-all
...
export const PropertiesPanel: FC = memo(() => {
    ...
    const panelCls = `relative w-full bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/60 rounded-lg
                      p-3 text-[#dae2fd] font-sans z-50 flex flex-col gap-1.5
        ...
        return (
            <button type="button"
                ...
                className="w-full bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/60 rounded-lg
                           ...
                           font-medium tracking-wide tracking-wide hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors"
                title="Expand Properties Panel"
            >
                <Settings2 className="w-4 h-4 text-[#869ab8]" />
                Properties
    ...
    if (selectedIds.size > 1) {
            ...
            return (
                <div className={panelCls}>
                    ...
                    <button type="button"
                        ...
                        className="w-full py-1.5 rounded border border-red-500/40 text-red-400 text-xs font-medium tracking-wide tracking-wide
        ...
        return (
            <div className={panelCls}>
                ...
                <div className="text-[13px] mb-2 space-y-0.5 text-[#869ab8]">
            ...
            <div className={panelCls}>
                ...
                <PanelSection icon={<Lock className="w-3.5 h-3.5 text-emerald-400" />} label="Boundary Conditions">
                    ...
                    <div className="mt-1.5 py-1 px-2 bg-emerald-500/5 rounded text-center">
                        <span className="text-[11px] text-emerald-400 font-medium tracking-wide tracking-wide">
                ...
                <PanelSection icon={<ArrowDown className="w-3.5 h-3.5 text-yellow-400" />} label="Nodal Loads">
                    ...
                    <div className="mt-2 p-2 bg-slate-100/50 dark:bg-slate-800/50 rounded-md">
                        ...
                        <button type="button"
                            ...
                            className="w-full mt-2 py-1.5 bg-blue-600/80 hover:bg-blue-600 text-white text-xs font-medium tracking-wide tracking-wide rounded
                    ...
                    <>
                        ...
                        <div className="bg-gradient-to-br from-emerald-950/30 to-black/20 rounded-md p-2.5 border border-emerald-500/20">
                            <div className="flex items-center gap-1.5 mb-2">
                                ...
                                <span className="text-xs font-medium tracking-wide tracking-wide text-emerald-400">Analysis Results</span>
                            </div>
        ...
        return (
            <div className={panelCls}>
                ...
                <PanelSection icon={<Box className="w-3.5 h-3.5 text-cyan-400" />} label="Section">
                    ...
                    {showCustomSection && (
                        <div className="bg-[#131b2e] p-3 rounded-lg mt-2 border border-slate-300 dark:border-slate-600">
                            ...
                            <div className="flex flex-col gap-2">
                                {[
                                    ...
                                    <div key={label} className="flex items-center gap-2">
                                        <label className="text-[11px] w-20 text-[#869ab8]">{label}</label>
                            ...
                            <div className="flex gap-2 mt-3">
                                <button type="button" onClick={handleApplyCustomSection}
                                    className="flex-1 py-1.5 bg-emerald-600/80 hover:bg-emerald-600 text-white text-xs font-medium tracking-wide tracking-wide rounded transition-colors">
                                    Apply
                                </button>
                                <button type="button" onClick={() => setShowCustomSection(false)}
                                    className="flex-1 py-1.5 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-xs font-medium tracking-wide tracking-wide rounded transition-colors">
                                    Cancel
                                </button>
                            </div>
                        </div>
                    ...
                    {showCustomMaterial && (
                        <div className="bg-[#131b2e] p-3 rounded-lg mt-2 border border-slate-300 dark:border-slate-600">
                            ...
                            <div className="flex items-center gap-2">
                                <label className="text-[11px] w-20 text-[#869ab8]">E (GPa)</label>
                                <NumberInput value={customE} onChange={setCustomE} className="flex-1" />
                            </div>
                            <div className="flex gap-2 mt-3">
                                <button type="button" onClick={handleApplyCustomMaterial}
                                    className="flex-1 py-1.5 bg-blue-600/80 hover:bg-blue-600 text-white text-xs font-medium tracking-wide tracking-wide rounded transition-colors">
                                    Apply
                                </button>
                    ...
                    <div className="grid grid-cols-2 gap-2 bg-slate-100/50 dark:bg-slate-800/50 p-2 rounded-md">
                        ...
                        <div className="text-center">
                            ...
                            <label className={`flex flex-col items-center py-2 px-2 rounded cursor-pointer border-2 transition-all
                                ${releases.startMoment ? 'border-orange-500 bg-orange-500/10' : 'border-[#1a2333] bg-[#131b2e]'}`}>
                        ...
                        <div className="text-center">
                            ...
                            <label className={`flex flex-col items-center py-2 px-2 rounded cursor-pointer border-2 transition-all
                                ${releases.endMoment ? 'border-orange-500 bg-orange-500/10' : 'border-[#1a2333] bg-[#131b2e]'}`}>
                ...
                {forces && (
                    <>
                        ...
                        <div className="bg-gradient-to-br from-emerald-950/30 to-black/20 rounded-md p-2.5 border border-emerald-500/20">
                            <div className="flex items-center gap-1.5 mb-2">
                                <Activity className="w-3.5 h-3.5 text-emerald-400" />
                                <span className="text-xs font-medium tracking-wide tracking-wide text-emerald-400">Member End Forces</span>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-1">
                                <InfoRow
                                    ...
                                    borderColor={forces.axial > 0 ? 'border-red-500' : forces.axial < 0 ? 'border-blue-500' : 'border-[#1a2333]'}
                                />
                ...
                <PanelSection icon={<ArrowDown className="w-3.5 h-3.5 text-purple-400" />} label="Member Loads (UDL)">
                        ...
                        <div className="space-y-1.5">
                            {loadsForMember.map((ml, idx) => (
                                <div key={ml.id} className="bg-purple-500/10 border border-purple-500/20 p-2 rounded-md">
                                    ...
                                    <div className="text-[11px] mt-1 font-mono text-[#869ab8]">
                    ...
                    <div className="mt-2">
                        <button type="button"
                            ...
                            className={`w-full py-1.5 text-xs font-medium tracking-wide tracking-wide rounded transition-colors flex items-center justify-center gap-1
                            ...
                            <div className="bg-purple-500/5 border border-purple-500/20 p-2.5 rounded-lg mt-2">
                                <div className="space-y-2">
                                    ...
                                    <button type="button"
                                        ...
                                        className="w-full py-1.5 bg-emerald-600/80 hover:bg-emerald-600 text-white text-xs font-medium tracking-wide tracking-wide rounded
                                                   transition-colors flex items-center justify-center gap-1"
                                    >
