...
const { STEEL_SECTIONS, getSectionsByType, getSectionById, MATERIALS_DATABASE } = SectionDatabase;
...
import {
    ...
    convertSectionToMeters,
    getSectionsByCategory,
} from './properties-panel/helpers';
import {
    Divider,
    DofToggle,
    InfoRow,
        ...
        return (
            <button type="button"
                ...
                className="w-full bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border border-slate-200/60 dark:border-slate-700/60 rounded-lg
                           ...
                           font-medium tracking-wide hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors"
        ...
        if (selectedMembers.length > 0 && selectedNodes.length === 0) {
            const handleBulkSectionChange = (sectionId: string) => {
                ...
                if (section) {
                    ...
                    updateMembers(new Map<string, Partial<typeof selectedMembers[0]>>());
                }
            };
            ...
            return (
                <div className={panelCls}>
                    ...
                    <button type="button"
                        ...
                        className="w-full py-1.5 rounded border border-red-500/40 text-red-400 text-xs font-medium tracking-wide
                ...
                <PanelSection icon={<ArrowDown className="w-3.5 h-3.5 text-yellow-400" />} label="Nodal Loads">
                    ...
                    <div className="mt-2 p-2 bg-slate-100/50 dark:bg-slate-800/50 rounded-md">
                        ...
                        <button type="button"
                            ...
                            className="w-full mt-2 py-1.5 bg-blue-600/80 hover:bg-blue-600 text-white text-xs font-medium tracking-wide rounded
                    ...
                    <>
                        ...
                        <div className="bg-gradient-to-br from-emerald-950/30 to-black/20 rounded-md p-2.5 border border-emerald-500/20">
                            <div className="flex items-center gap-1.5 mb-2">
                                ...
                                <span className="text-xs font-medium tracking-wide text-emerald-400">Analysis Results</span>
                            </div>
                        ...
                        <div className="bg-[#131b2e] p-3 rounded-lg mt-2 border border-slate-300 dark:border-slate-600">
                            ...
                            <div className="flex gap-2 mt-3">
                                <button type="button" onClick={handleApplyCustomSection}
                                    className="flex-1 py-1.5 bg-emerald-600/80 hover:bg-emerald-600 text-white text-xs font-medium tracking-wide rounded transition-colors">
                                    Apply
                                </button>
                                <button type="button" onClick={() => setShowCustomSection(false)}
                                    className="flex-1 py-1.5 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-xs font-medium tracking-wide rounded transition-colors">
                                    Cancel
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#131b2e] p-3 rounded-lg mt-2 border border-slate-300 dark:border-slate-600">
                            ...
                            <div className="flex gap-2 mt-3">
                                <button type="button" onClick={handleApplyCustomMaterial}
                                    className="flex-1 py-1.5 bg-blue-600/80 hover:bg-blue-600 text-white text-xs font-medium tracking-wide rounded transition-colors">
                                    Apply
                                </button>
                ...
                {forces && (
                    <>
                        ...
                        <div className="bg-gradient-to-br from-emerald-950/30 to-black/20 rounded-md p-2.5 border border-emerald-500/20">
                            <div className="flex items-center gap-1.5 mb-2">
                                <Activity className="w-3.5 h-3.5 text-emerald-400" />
                                <span className="text-xs font-medium tracking-wide text-emerald-400">Member End Forces</span>
                            </div>
                ...
                <PanelSection icon={<ArrowDown className="w-3.5 h-3.5 text-purple-400" />} label="Member Loads (UDL)">
                    ...
                    <div className="mt-2">
                        <button type="button"
                            ...
                            className={`w-full py-1.5 text-xs font-medium tracking-wide rounded transition-colors flex items-center justify-center gap-1
                            ...
                            <div className="bg-purple-500/5 border border-purple-500/20 p-2.5 rounded-lg mt-2">
                                <div className="space-y-2">
                                    ...
                                    <button type="button"
                                        ...
                                        className="w-full py-1.5 bg-emerald-600/80 hover:bg-emerald-600 text-white text-xs font-medium tracking-wide rounded
                                                   transition-colors flex items-center justify-center gap-1"
                                    >
