            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {filtered.map((template) => (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                    >
                        <div className={`mb-2 ${selected?.id === template.id ? 'text-cyan-400' : 'text-slate-400'}`}>
                            {template.icon}
                        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    <label className="text-sm text-slate-400">Span / Width</label>
                ...
                {(template?.category === 'frame') && (
                    <>
                        <div className="space-y-2">
                            <label className="text-sm text-slate-400">Number of Bays</label>
                            <input
                                type="number"
                                min={1}
                                max={10}
                        ...
                        <div className="space-y-2">
                            <label className="text-sm text-slate-400">Number of Stories</label>
                            <input
                                type="number"
                                min={1}
                                max={20}
...
const MaterialStep: FC<MaterialStepProps> = ({ 
    ...
    return (
        <div className="space-y-6">
            {/* Material Selection */}
            <div>
                <h4 className="text-sm font-medium text-slate-300 mb-3">Select Material</h4>
            ...
            {/* Section Selection */}
            <div>
                <h4 className="text-sm font-medium text-slate-300 mb-3">Select Section</h4>
                <div className="space-y-2">
                    {sections.map((sec) => (
                        <button
                            key={sec.id}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-2 py-1 bg-slate-700 border border-slate-600 
                                             rounded text-sm text-slate-200"
                                />
                            </div>
                            <div>
...
const ReviewStep: FC<ReviewStepProps> = ({ state, onRun }) => {
    return (
        <div className="space-y-6">
            ...
            {/* Analysis options */}
            <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                <h4 className="text-sm font-medium text-slate-300 mb-3">Analysis Options</h4>
                <div className="space-y-2">
    ...
    return (
        <div className="bg-slate-900 rounded-xl border border-slate-700 overflow-hidden max-w-3xl mx-auto">
            ...
            <div className="px-6 py-4 border-b border-slate-700 flex items-center justify-between">
                <div>
                    <h2 className="text-lg font-semibold text-white">Analysis Setup Wizard</h2>
                        ...
                        <React.Fragment key={step.id}>
                            ...
                            {idx < steps.length - 1 && (
                                <div className={`flex-1 h-0.5 mx-2 ${
                                    idx < state.currentStep ? 'bg-cyan-400' : 'bg-slate-700'
                                }`} />
                            )}
                        </React.Fragment>
                    ))}
