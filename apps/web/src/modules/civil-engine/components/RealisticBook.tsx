...
const TitlePageContent: React.FC = () => (
  <div className="page-content flex flex-col items-center justify-center text-center">
    ...
    <div className="mt-auto pt-12">
      <p className="text-[#869ab8] text-sm">{BOOK_METADATA.edition}</p>
      <p className="text-[#869ab8] text-xs mt-1">ISBN: {BOOK_METADATA.isbn}</p>
    </div>
  </div>
);
        ...
        {chapters.map((ch, i) => (
          ...
          >
            ...
            <span className="flex-1">
              ...
              <span className="text-sm text-[#869ab8]">{ch.subtitle}</span>
            </span>
            <span className="text-[#869ab8] font-mono text-sm">{ch.page}</span>
          </button>
        ))}
...
const ChapterStartContent: React.FC<ChapterPageProps> = ({ number, title, subtitle, icon }) => (
  <div className="page-content flex flex-col items-center justify-center text-center h-full">
    ...
    <p className="text-[#869ab8] italic">{subtitle}</p>
    ...
    <div className="space-y-6 text-sm">
      {sections.map((section, i) => (
        <div key={i}>
          ...
          {section.formula && (
            <div className="my-3 p-3 bg-[#131b2e] rounded font-mono text-xs text-amber-100 
    ...
    <div className="space-y-4">
      ...
      <div className="border border-amber-200 rounded overflow-hidden">
        ...
        <div className="p-3 space-y-2 font-mono text-xs">
          <div className="p-2 bg-[#131b2e] text-amber-100 rounded">σ = M·y/I</div>
          <div className="p-2 bg-[#131b2e] text-amber-100 rounded">δ = PL³/3EI</div>
          <div className="p-2 bg-[#131b2e] text-amber-100 rounded">Pcr = π²EI/L²</div>
        </div>
      </div>
    </div>
    
    <div className="mt-6 pt-4 border-t border-amber-200/50 text-center text-[#869ab8] text-xs">
