...
impl SectionDatabase {
    ...
    fn load_aisc_sections(&mut self) {
        let aisc_sections = vec![
            ...
            ("W10x45",   256.5, 203.7, 7.9, 15.7, 5700.0, 11130.0e4, 849.0e4, 867.8e3, 83.3e3, 988.0e3, 128.3e3, 26.4e4, 0.0, 139.7, 38.6, 66.9),
            ...
            ("W12x50",   309.9, 205.2, 9.4, 16.3, 6380.0, 21160.0e4, 949.0e4, 1365.6e3, 92.5e3, 1530.0e3, 142.4e3, 37.3e4, 0.0, 182.1, 38.6, 74.4),
            ("W14x22",   349.4, 127.0, 5.8, 8.5, 2840.0, 11430.0e4, 145.0e4, 654.1e3, 22.8e3, 744.3e3, 35.6e3, 4.3e4, 0.0, 200.7, 22.6, 32.7),
            ("W14x30",   351.8, 171.4, 6.9, 9.8, 3790.0, 17010.0e4, 433.0e4, 967.2e3, 50.5e3, 1082.0e3, 78.0e3, 8.8e4, 0.0, 211.8, 33.8, 44.6),
            ...
            ("W16x50",   412.8, 179.7, 9.7, 16.0, 6370.0, 42280.0e4, 662.0e4, 2048.8e3, 73.7e3, 2308.0e3, 113.5e3, 35.4e4, 0.0, 257.8, 32.3, 74.4),
            ("W18x50",   457.2, 190.5, 9.0, 14.5, 6350.0, 53950.0e4, 805.0e4, 2360.8e3, 84.5e3, 2663.0e3, 130.2e3, 34.0e4, 0.0, 291.3, 35.6, 74.4),
            ("W18x60",   462.8, 191.5, 10.5, 17.3, 7610.0, 66060.0e4, 970.0e4, 2855.4e3, 101.4e3, 3225.0e3, 156.4e3, 55.4e4, 0.0, 294.6, 35.7, 89.3),
            ("W21x44",   525.8, 165.1, 8.9, 11.4, 5580.0, 69680.0e4, 396.0e4, 2650.8e3, 48.0e3, 3016.0e3, 74.4e3, 21.7e4, 0.0, 353.3, 26.6, 65.5),
            ("W21x62",   533.4, 209.3, 10.2, 15.6, 7870.0, 93570.0e4, 1190.0e4, 3509.5e3, 113.7e3, 3932.0e3, 175.0e3, 51.8e4, 0.0, 345.0, 38.9, 92.3),
            ("W24x55",   599.4, 177.8, 10.0, 12.8, 6960.0, 111060.0e4, 556.0e4, 3707.0e3, 62.5e3, 4179.0e3, 96.7e3, 33.6e4, 0.0, 399.3, 28.3, 81.9),
            ("W24x76",   607.6, 228.6, 11.2, 17.3, 9650.0, 152220.0e4, 1730.0e4, 5011.8e3, 151.4e3, 5609.0e3, 232.8e3, 82.2e4, 0.0, 397.1, 42.3, 113.1),
            ("W27x84",   678.2, 253.7, 11.7, 16.3, 10700.0, 213930.0e4, 2200.0e4, 6308.8e3, 173.4e3, 7097.0e3, 267.0e3, 87.1e4, 0.0, 447.0, 45.4, 125.0),
    ...
    fn load_eurocode_sections(&mut self) {
        let euro_sections = vec![
            ...
            ("IPE 140", 140.0, 73.0, 4.7, 6.9, 16.4e2, 541.0e4, 44.9e4, 77.3e3, 12.3e3, 88.3e3, 19.3e3, 2.5e4, 0.0, 57.4, 16.5, 12.9),
            ("IPE 160", 160.0, 82.0, 5.0, 7.4, 20.1e2, 869.0e4, 68.3e4, 109.0e3, 16.7e3, 124.0e3, 26.1e3, 3.6e4, 0.0, 65.8, 18.4, 15.8),
            ("IPE 180", 180.0, 91.0, 5.3, 8.0, 23.9e2, 1317.0e4, 101.0e4, 146.3e3, 22.2e3, 166.4e3, 34.6e3, 4.8e4, 0.0, 74.2, 20.5, 18.8),
            ("IPE 200", 200.0, 100.0, 5.6, 8.5, 28.5e2, 1943.0e4, 142.0e4, 194.0e3, 28.5e3, 221.0e3, 44.6e3, 7.0e4, 0.0, 82.6, 22.4, 22.4),
            ("IPE 220", 220.0, 110.0, 5.9, 9.2, 33.4e2, 2772.0e4, 205.0e4, 252.0e3, 37.3e3, 285.4e3, 58.1e3, 9.1e4, 0.0, 91.1, 24.8, 26.2),
            ("IPE 240", 240.0, 120.0, 6.2, 9.8, 39.1e2, 3892.0e4, 284.0e4, 324.0e3, 47.3e3, 367.0e3, 73.9e3, 12.9e4, 0.0, 99.7, 26.9, 30.7),
            ("IPE 270", 270.0, 135.0, 6.6, 10.2, 45.9e2, 5790.0e4, 420.0e4, 429.0e3, 62.2e3, 484.0e3, 97.0e3, 15.9e4, 0.0, 112.3, 30.2, 36.1),
            ("IPE 300", 300.0, 150.0, 7.1, 10.7, 53.8e2, 8356.0e4, 604.0e4, 557.0e3, 80.5e3, 628.0e3, 125.2e3, 20.1e4, 0.0, 124.6, 33.5, 42.2),
            ("IPE 330", 330.0, 160.0, 7.5, 11.5, 62.6e2, 11770.0e4, 788.0e4, 713.0e3, 98.5e3, 804.3e3, 153.7e3, 28.1e4, 0.0, 137.1, 35.5, 49.1),
            ...
            ("IPE 450", 450.0, 190.0, 9.4, 14.6, 98.8e2, 33740.0e4, 1676.0e4, 1500.0e3, 176.4e3, 1702.0e3, 276.4e3, 66.9e4, 0.0, 184.8, 41.2, 77.6),
            ("IPE 500", 500.0, 200.0, 10.2, 16.0, 115.5e2, 48200.0e4, 2142.0e4, 1928.0e3, 214.2e3, 2194.0e3, 336.0e3, 89.3e4, 0.0, 204.3, 43.1, 90.7),
            ("IPE 550", 550.0, 210.0, 11.1, 17.2, 134.4e2, 67120.0e4, 2668.0e4, 2441.0e3, 254.1e3, 2787.0e3, 400.5e3, 123.0e4, 0.0, 223.5, 44.6, 105.5),
            ...
            ("HEA 140", 133.0, 140.0, 5.5, 8.5, 31.4e2, 1033.0e4, 389.0e4, 155.4e3, 55.6e3, 173.5e3, 85.2e3, 8.1e4, 0.0, 57.3, 35.2, 24.7),
            ("HEA 160", 152.0, 160.0, 6.0, 9.0, 38.8e2, 1673.0e4, 616.0e4, 220.1e3, 77.0e3, 245.1e3, 117.6e3, 12.2e4, 0.0, 65.7, 39.8, 30.4),
            ("HEA 200", 190.0, 200.0, 6.5, 10.0, 53.8e2, 3692.0e4, 1336.0e4, 389.0e3, 134.0e3, 429.5e3, 204.0e3, 21.0e4, 0.0, 82.8, 49.8, 42.3),
            ("HEA 240", 230.0, 240.0, 7.5, 12.0, 76.8e2, 7763.0e4, 2769.0e4, 675.1e3, 230.7e3, 744.6e3, 351.7e3, 41.6e4, 0.0, 100.5, 60.0, 60.3),
            ...
            ("HEB 140", 140.0, 140.0, 7.0, 12.0, 43.0e2, 1509.0e4, 550.0e4, 215.6e3, 78.5e3, 245.4e3, 120.0e3, 20.1e4, 0.0, 59.2, 35.7, 33.7),
            ("HEB 160", 160.0, 160.0, 8.0, 13.0, 54.3e2, 2492.0e4, 889.0e4, 311.5e3, 111.2e3, 354.0e3, 170.0e3, 31.2e4, 0.0, 67.8, 40.5, 42.6),
            ("HEB 200", 200.0, 200.0, 9.0, 15.0, 78.1e2, 5696.0e4, 2003.0e4, 570.0e3, 200.3e3, 642.5e3, 306.0e3, 59.3e4, 0.0, 85.4, 50.7, 61.3),
            ("HEB 240", 240.0, 240.0, 10.0, 17.0, 106.0e2, 11260.0e4, 3923.0e4, 938.3e3, 327.0e3, 1053.0e3, 498.4e3, 103.0e4, 0.0, 103.1, 60.8, 83.2),
