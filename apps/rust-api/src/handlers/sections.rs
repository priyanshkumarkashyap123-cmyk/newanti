...
fn get_section_database() -> Vec<SteelSection> {
    vec![
        ...
        SteelSection {
            ...
            sx: 51400.0, sy: 6980.0, rx: 47.5, ry: 15.2, weight: 8.9,
        },
        SteelSection {
            id: "ISMB150".into(),
            name: "ISMB 150".into(),
            ...
            sx: 96800.0, sy: 8750.0, rx: 66.3, ry: 14.6, weight: 13.0,
        },
        SteelSection {
            id: "ISMB200".into(),
            name: "ISMB 200".into(),
            ...
            sx: 229000.0, sy: 30000.0, rx: 84.2, ry: 21.5, weight: 25.4,
        },
        SteelSection {
            id: "ISMB250".into(),
            name: "ISMB 250".into(),
            ...
            sx: 410000.0, sy: 53400.0, rx: 105.0, ry: 26.9, weight: 36.3,
        },
        SteelSection {
            id: "ISMB300".into(),
            name: "ISMB 300".into(),
            ...
            sx: 533000.0, sy: 64700.0, rx: 119.0, ry: 28.4, weight: 44.2,
        },
        SteelSection {
            id: "ISMB350".into(),
            name: "ISMB 350".into(),
            ...
            sx: 779000.0, sy: 76900.0, rx: 143.0, ry: 28.4, weight: 52.4,
        },
        SteelSection {
            id: "ISMB400".into(),
            name: "ISMB 400".into(),
            ...
            sx: 1023000.0, sy: 88900.0, rx: 161.0, ry: 28.1, weight: 61.6,
        },
        SteelSection {
            id: "ISMB450".into(),
            name: "ISMB 450".into(),
            ...
            sx: 1351000.0, sy: 111000.0, rx: 182.0, ry: 30.1, weight: 72.4,
        },
        SteelSection {
            id: "ISMB500".into(),
            name: "ISMB 500".into(),
            ...
            sx: 1809000.0, sy: 152000.0, rx: 202.0, ry: 35.2, weight: 86.9,
        },
        SteelSection {
            id: "ISMB600".into(),
            name: "ISMB 600".into(),
            ...
            sx: 3060000.0, sy: 253000.0, rx: 243.0, ry: 41.3, weight: 122.6,
        },
        ...
        SteelSection {
            ...
            sx: 473000.0, sy: 69100.0, rx: 141.0, ry: 32.5, weight: 32.7,
        },
        SteelSection {
            id: "W14x30".into(),
            name: "W14×30".into(),
            ...
            sx: 697000.0, sy: 141000.0, rx: 147.0, ry: 46.2, weight: 44.5,
        },
        SteelSection {
            id: "W18x35".into(),
            name: "W18×35".into(),
            ...
            sx: 1027000.0, sy: 109000.0, rx: 186.0, ry: 35.4, weight: 52.2,
        },
        SteelSection {
            id: "W21x44".into(),
            name: "W21×44".into(),
            ...
            sx: 1337000.0, sy: 133000.0, rx: 204.0, ry: 36.2, weight: 65.5,
        },
        SteelSection {
            id: "W24x55".into(),
            name: "W24×55".into(),
            ...
            sx: 1873000.0, sy: 170000.0, rx: 231.0, ry: 38.1, weight: 81.9,
        },
        ...
        SteelSection {
            ...
            sx: 302000.0, sy: 302000.0, rx: 58.0, ry: 58.0, weight: 53.7,
        },
        SteelSection {
            id: "HSS8x8x0.5".into(),
            name: "HSS 8×8×½".into(),
    ...
    let filtered: Vec<SteelSection> = sections
        ...
        .filter(|s| {
            ...
            if let Some(min_d) = req.min_depth {
                if s.d < min_d { return false; }
            }
            if let Some(max_d) = req.max_depth {
                if s.d > max_d { return false; }
            }
            // Filter by minimum area
            if let Some(min_a) = req.min_area {
                if s.a < min_a { return false; }
            }
            true
        })
        .collect();
