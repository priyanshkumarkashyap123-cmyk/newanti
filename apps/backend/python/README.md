...
FastAPI-style service for analysis/design routes and Python-side compute.
...
## Build/Run (container)
- docker build -t beamlab-backend-python .
- docker run -p 8000:8000 beamlab-backend-python

## Notes
- Requires INTERNAL_SERVICE_SECRET, JWT_SECRET from vault.
- Depends on Rust API/Node gateway for certain routes.# BeamLab Structural Engine - Python Backend
