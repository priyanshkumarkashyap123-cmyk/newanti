# BeamLab Rust API 🦀
# Backend Rust API (apps/backend/rust-api)

Axum-based Rust service for high-performance analysis/design APIs.

## Dev
- cargo run --release --bin beamlab-rust-api

## Build (container)
- docker build -t beamlab-backend-rust-api .

## Notes
- Requires MONGODB_URI, JWT_SECRET, INTERNAL_SERVICE_SECRET from vault.
- Exposes health at /health, readiness at /health (configurable).
