  ...
  parseAndValidate(content) {
    try {
      ...
      for (const node of parsed.nodes) {
        if (typeof node.id !== "string" || typeof node.x !== "number" || typeof node.y !== "number" || typeof node.z !== "number") {
          return null;
        }
      }
      const nodeIds = new Set(parsed.nodes.map((n) => n.id));
      for (const member of parsed.members) {
        if (typeof member.id !== "string" || typeof member.startNodeId !== "string" || typeof member.endNodeId !== "string" || typeof member.section !== "string") {
          return null;
        }
...
const modelGeneratorService = new ModelGeneratorService();
var ModelGeneratorService_default = modelGeneratorService;
export {
  ModelGeneratorService,
  ModelGeneratorService_default as default,
  modelGeneratorService
};
//# sourceMappingURL=ModelGeneratorService.js.map
