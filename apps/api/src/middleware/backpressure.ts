...
const ANALYSIS_MAX_IN_FLIGHT = envInt("ANALYSIS_MAX_IN_FLIGHT", 5);
...
const ADVANCED_MAX_IN_FLIGHT = envInt("ADVANCED_MAX_IN_FLIGHT", 5);
...
const DESIGN_MAX_IN_FLIGHT = envInt("DESIGN_MAX_IN_FLIGHT", 5);
