 ...
 */
function wizardConfigToRequest(
  config: WizardConfig,
  options?: {
 ...
 */
function buildConstraintReport(response: LayoutV2Response): ConstraintReport {
 ...
 */
async function optimizeLayoutV2(request: LayoutV2Request): Promise<LayoutV2Response> {
 ...
 */
function serializeCanonicalReport(
 ...
 */
function downloadCanonicalReport(
  response: LayoutV2Response,
  report: ConstraintReport,
...
// Internal helpers are intentionally not exported to avoid unused export noise
