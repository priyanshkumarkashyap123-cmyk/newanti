        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0b1326] rounded-xl p-6 border border-[#1a2333]">
              ...
              <div className="space-y-3">
                {loadCases.map((loadCase) => {
                  ...
                  return (
                    <div key={loadCase.id} className="bg-[#131b2e] p-4 rounded-lg flex items-center gap-3">
          ...
          <div className="lg:col-span-1">
            {combinations.length > 0 ? (
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 rounded-xl p-6 border border-[#1a2333]">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold text-white">Combinations</h2>
                  <button type="button"
                    onClick={downloadCombinations}
                    className="p-2 bg-gradient-to-r from-[#4d8eff] to-[#3b72cc] hover:from-[#3b72cc] hover:to-[#2a5599] text-white shadow-[0_0_15px_rgba(77,142,255,0.3)] hover:shadow-[0_0_20px_rgba(77,142,255,0.5)] rounded-lg transition-colors"
                  >
                ...
                <div className="space-y-2 max-h-[600px] overflow-y-auto">
                  {combinations.map((combo) => (
                    <div key={combo.id} className="bg-[#131b2e] p-4 rounded-lg">
                      <div className="flex items-start justify-between mb-2">
                        <h4 className="font-semibold text-[#dae2fd] text-sm">{combo.name}</h4>
                      ...
                      <div className="space-y-1">
                        {combo.cases.map((c, idx) => {
                          ...
                          return (
                            <div key={idx} className="text-xs text-[#869ab8] flex items-center gap-2">
              ...
              <div className="bg-[#0b1326] rounded-xl p-6 border border-[#1a2333] h-full">
                <div className="flex flex-col items-center justify-center py-12 text-center h-full">
                  ...
                  <h3 className="text-lg font-semibold text-[#869ab8] mb-2">No Combinations Yet</h3>
