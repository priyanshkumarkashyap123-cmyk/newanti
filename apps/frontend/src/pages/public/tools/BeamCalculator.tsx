    ...
    return (
        <div className="bg-slate-100/50 dark:bg-slate-800/50 rounded-xl p-4">
            ...
            <div className="flex items-center gap-2 mb-4">
                <span className="text-[#869ab8] text-sm">Add:</span>
                <button type="button"
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-50 dark:from-slate-900 to-white dark:to-slate-950">
            ...
            <header className="border-b border-[#1a2333] bg-slate-50/80 dark:bg-slate-900/80 backdrop-blur-xl sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <button type="button" className="text-[#869ab8] hover:text-slate-900 dark:hover:text-white p-2">
            ...
            <main className="max-w-6xl mx-auto px-4 py-8">
                {/* Title */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-[#dae2fd] mb-2">Simple Beam Calculator</h1>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-slate-100/50 dark:bg-slate-800/50 rounded-xl p-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div>
                                    <label className="text-[#869ab8] text-xs block mb-1">Length (m)</label>
                                    <input
                                        type="number"
                                        value={model.length}
                                        onChange={(e) => setModel({ ...model, length: parseFloat(e.target.value) || 1 })}
                                        className="w-full px-3 py-2 bg-slate-200 dark:bg-slate-700 text-[#dae2fd] rounded-lg border border-slate-600 focus:border-blue-500 focus:outline-none"
                                    />
                                </div>
                                <div>
                                    <label className="text-[#869ab8] text-xs block mb-1">E (GPa)</label>
                                    <input
                                        type="number"
                                        value={model.E}
                                ...
                                <div>
                                    <label className="text-[#869ab8] text-xs block mb-1">I (cm⁴)</label>
                                    <input
                                        type="number"
                                        value={model.I}
                            ...
                            {results ? (
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-slate-200/50 dark:bg-slate-700/50 rounded-lg p-3">
                                        <div className="text-[#869ab8] text-xs mb-1">Reactions</div>
                                        {results.reactions.map((r, i) => (
                                            <div key={i} className="text-[#dae2fd] text-sm">
                                    ...
                                    {/* Max Values */}
                                    <div className="bg-slate-200/50 dark:bg-slate-700/50 rounded-lg p-3">
                                        <div className="text-[#869ab8] text-xs mb-1">Max Shear</div>
                                        <div className="text-xl font-bold text-red-400">
                                            {results.maxShear.toFixed(2)} kN
                                        </div>
                                    </div>
                                    <div className="bg-slate-200/50 dark:bg-slate-700/50 rounded-lg p-3">
                                        <div className="text-[#869ab8] text-xs mb-1">Max Moment</div>
                                        <div className="text-xl font-bold text-purple-400">
                                            {results.maxMoment.toFixed(2)} kN·m
                                        </div>
                                    </div>
                                    <div className="bg-slate-200/50 dark:bg-slate-700/50 rounded-lg p-3">
                                        <div className="text-[#869ab8] text-xs mb-1">Max Deflection</div>
                                ...
                                <div className="text-[#869ab8] text-center py-8">
                ...
                {results && (
                    <div className="mt-12 bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-blue-800/50 rounded-2xl p-8 text-center">
                        ...
                        <p className="text-[#869ab8] mb-6 max-w-lg mx-auto">
