    ...
    return (
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-40">
            <div className="bg-surface-dark border border-border-dark rounded-xl shadow-2xl p-4 min-w-[300px] max-w-md">
                ...
                <div className="bg-white/50 dark:bg-slate-900/50 rounded-lg p-2 mb-3 max-h-24 overflow-y-auto">
                ...
                <div className="flex flex-wrap gap-2">
                    {hasNodes && onApplySupport && (
                        <button type="button"
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium tracking-wide rounded-lg bg-orange-500/20 text-orange-400 hover:bg-orange-500/30 transition-colors"
                        >
                    ...
                    {hasNodes && onApplyLoad && (
                        <button type="button"
                            onClick={onApplyLoad}
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium tracking-wide rounded-lg bg-red-500/20 text-red-400 hover:bg-red-500/30 transition-colors"
                        >
                    ...
                    {hasMembers && onApplyLoad && (
                        <button type="button"
                            onClick={onApplyLoad}
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium tracking-wide rounded-lg bg-purple-500/20 text-purple-400 hover:bg-purple-500/30 transition-colors"
                        >
                    ...
                    {onRunAnalysis && (
                        <button type="button"
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium tracking-wide rounded-lg bg-primary/20 text-primary hover:bg-primary/30 transition-colors"
                        >
                    ...
                    {onDelete && (
                        <button type="button"
                            onClick={onDelete}
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium tracking-wide rounded-lg bg-slate-200/50 dark:bg-slate-700/50 text-[#869ab8] hover:bg-red-500/20 hover:text-red-400 transition-colors ml-auto"
                        >
                ...
                <div className="mt-3 pt-2 border-t border-border-dark">
                    <p className="text-[10px] text-text-muted text-center">
                        <span className="font-medium tracking-wide">Tip:</span> Hold <kbd className="bg-slate-200 dark:bg-slate-700 px-1 rounded">Shift</kbd> or <kbd className="bg-slate-200 dark:bg-slate-700 px-1 rounded">Ctrl</kbd> to multi-select
                    </p>
                </div>
            </div>
        </div>
