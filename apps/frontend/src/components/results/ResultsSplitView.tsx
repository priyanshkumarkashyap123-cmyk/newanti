...
export const ResultsSplitView: FC<ResultsSplitViewProps> = ({
    ...
    return (
        <div className={`fixed inset-0 z-50 bg-[#0b1326] ${isFullscreen ? '' : 'p-4'} ${className}`}>
            {/* Header Bar */}
            <div className="h-12 bg-[#0b1326] border-b border-[#1a2333] flex items-center justify-between px-4">
                <div className="flex items-center gap-4">
                    <h2 className="text-lg font-semibold text-[#dae2fd]">Analysis Results</h2>
                    <div className="flex items-center gap-1 text-sm text-[#869ab8]">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button type="button"
                        ...
                        className="p-2 text-[#869ab8] hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-800 rounded transition-colors"
                    ...
                    {onClose && (
                        <button type="button"
                            onClick={onClose}
                            className="p-2 text-[#869ab8] hover:text-white hover:bg-red-800 rounded transition-colors"
            ...
            <div className="flex h-[calc(100%-3rem)]">
                ...
                {leftPanelOpen && (
                    <>
                        <div 
                            className="bg-[#0b1326] border-r border-[#1a2333] flex flex-col overflow-hidden"
                ...
                <div className="flex-1 flex flex-col">
                    {/* Main Viewport Area */}
                    <div className="flex-1 bg-[#0b1326] relative overflow-hidden">
                        {/* This is where the 3D viewport would render */}
                        <div className="absolute inset-0 flex items-center justify-center text-[#869ab8]">
                    ...
                    {bottomPanelOpen && (
                        <>
                            ...
                            <div 
                                className="bg-[#0b1326] border-t border-[#1a2333] overflow-auto"
    ...
    return (
        ...
        >
            ...
            <button type="button"
                ...
                className="absolute top-2 right-2 z-10 p-1 bg-[#131b2e] rounded hover:bg-slate-200 dark:hover:bg-slate-700"
            >
                {isCollapsed ? (
