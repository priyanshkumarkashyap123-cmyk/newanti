      ...
      <div className="flex items-center justify-center rounded-lg border border-slate-700 bg-slate-800/90 p-6">
        <div className="w-full max-w-sm space-y-3 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-blue-600 px-3 py-1.5 text-xs font-medium tracking-wide text-white transition hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            🔄 Retry
          </button>
        </div>
