...
const SortIcon: React.FC<{ direction: SortDirection; active: boolean }> = ({
  ...
  if (!active || !direction) {
    return <ChevronsUpDown className="w-4 h-4 text-[#869ab8]" />;
  }
...
export function DataTable<T extends Record<string, unknown>>({
  ...
  return (
    <div className={cn('w-full', className)}>
        ...
        <div className="mb-4 flex items-center gap-4">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className={cn(
                'w-full pl-9 pr-9 py-2 bg-[#131b2e] border border-slate-600 rounded-lg',
      ...
      {/* Table Container */}
      <div className="relative overflow-x-auto rounded-lg border border-[#1a2333]">
        <table className="w-full text-left">
          {/* Header */}
          <thead
            className={cn(
              'bg-slate-100/80 dark:bg-slate-800/80 text-xs uppercase text-[#869ab8] border-b border-[#1a2333]',
            ...
            <AnimatePresence mode="popLayout">
              {loading ? (
                ...
                Array.from({ length: pageSize }).map((_, i) => (
                  <tr key={`skeleton-${i}`} className="bg-[#0b1326]">
                    {selectable && (
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-sm text-[#869ab8]">
            ...
            <select
              ...
              className="bg-[#131b2e] border border-slate-600 rounded px-2 py-1 text-[#dae2fd]"
            >
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="px-4 text-sm text-[#869ab8]">
