        ...
        <Dialog open={true} onOpenChange={(open) => !open && onCancel()}>
            <DialogContent className="max-w-md">
                ...
                <DialogFooter className="sm:justify-center gap-3">
                    ...
                    <Button onClick={onConfirm} className={`flex-1 text-[#dae2fd] ${config.buttonBg}`}>
                        {confirmText}
                    </Button>
                </DialogFooter>
            </DialogContent>
        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onCancel()}>
            <DialogContent className="max-w-md">
                ...
                <DialogFooter className="sm:justify-center gap-3">
                    ...
                    <Button onClick={onConfirm} disabled={isLoading} className={`flex-1 text-[#dae2fd] ${config.buttonBg}`}>
                        {isLoading ? (
