        ...
        <AnimatePresence>
            ...
            >
                ...
                <motion.div
                    ...
                    className="fixed w-80 bg-[#0b1326] border border-[#1a2333] rounded-xl shadow-2xl overflow-hidden z-[1000]"
                    style={tooltipStyle}
                >
                    {/* Header */}
                    ...
                    {/* Content */}
                    <div className="p-4">
                        <h4 className="text-[#dae2fd] font-bold mb-2">{step.title}</h4>
                        <p className="text-sm text-[#869ab8] leading-relaxed">{step.content}</p>
                    </div>

                    {/* Footer */}
                    <div className="flex items-center justify-between px-4 py-3 bg-slate-100/30 dark:bg-slate-800/30 border-t border-[#1a2333]">
                        <button type="button"
                            onClick={handlePrevious}
                            disabled={currentStep === 0}
                            className="text-sm text-[#869ab8] hover:text-slate-900 dark:hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                        >
                            Previous
                        </button>
                        <button type="button"
            ...
            <AnimatePresence>
                {isVisible && (
                    <motion.div
                        ...
                        className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-[#131b2e] border border-[#1a2333] rounded-lg shadow-xl z-50 whitespace-nowrap"
                    >
