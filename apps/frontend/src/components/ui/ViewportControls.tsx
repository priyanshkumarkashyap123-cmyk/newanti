...
export const ZoomControls: FC<{
    ...
    <div className="flex flex-col items-center gap-1 p-1 bg-slate-50/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-xl border border-[#1a2333] shadow-lg">
        <ControlButton onClick={onZoomIn} icon={<ZoomIn className="w-4 h-4" />} label="Zoom In" />
        <div className="text-xs text-[#869ab8] font-mono py-1">
...
export const DisplayToggles: FC<{
    ...
    labelsEnabled = true,
        ...
        <div className="flex flex-col gap-1 p-1 bg-slate-50/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-xl border border-[#1a2333] shadow-lg">
            <ControlButton
    ...
    return (
        ...
        >
            ...
            <button type="button"
                ...
                className="p-2 text-[#869ab8] hover:text-slate-900 dark:hover:text-white text-xs flex items-center justify-center gap-1 bg-slate-50/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-lg border border-[#1a2333]"
            >
...
export const CoordinateDisplay: FC<CoordinateDisplayProps> = ({
    ...
    <div className={`
        ...
        bg-slate-50/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-lg border border-[#1a2333] shadow-lg
        font-mono text-xs
        ${className}
    `}>
