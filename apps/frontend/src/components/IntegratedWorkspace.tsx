        ...
        <div className="flex h-full">
            ...
            <div className="flex-1 relative">
                ...
                <div className="absolute top-4 left-4 z-10 flex gap-2">
                    ...
                    {/* Collaborators */}
                    <div className="px-3 py-2 bg-slate-100/80 dark:bg-slate-800/80 rounded-lg flex items-center gap-2 text-sm text-[#869ab8]">
                ...
                {analysisResult && analysisResult.status === 'complete' && (
                    <div className="absolute top-4 right-4 z-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-lg p-4 border border-[#1a2333]">
                        <div className="flex items-center gap-2 mb-3">
                            <CheckCircle className="w-4 h-4 text-green-400" />
                            <span className="text-sm font-bold text-[#dae2fd]">Analysis Complete</span>
                        </div>
                        <div className="grid grid-cols-3 gap-4 text-center">
                            <div>
                                ...
                                <div className="text-[10px] text-[#869ab8]">Max Deflection</div>
                            </div>
                            <div>
                                ...
                                <div className="text-[10px] text-[#869ab8]">Max Utilization</div>
                            </div>
                            <div>
                                <div className="text-lg font-mono text-green-400">
                                    ✓ OK
                                </div>
                                <div className="text-[10px] text-[#869ab8]">Status</div>
                            </div>
                        </div>
                    </div>
                )}
                ...
                <div className="absolute top-4 right-4 z-10 flex flex-col gap-2" style={{ top: analysisResult ? 140 : 16 }}>
                    <button type="button"
                        ...
                        className={`p-2 rounded-lg ${activePanel === 'design' ? 'bg-blue-600 text-white' : 'bg-[#131b2e] text-[#869ab8]'
                            }`}
                        title="Design Checks"
                    >
                    ...
                    <button type="button"
                        ...
                        className={`p-2 rounded-lg ${activePanel === 'validation' ? 'bg-emerald-600 text-white' : 'bg-[#131b2e] text-[#869ab8]'
                            }`}
                        title="Validation"
                    >
                    ...
                    <button type="button"
                        ...
                        className="p-2 rounded-lg bg-[#131b2e] text-[#869ab8] hover:bg-slate-200 dark:hover:bg-slate-700"
            ...
            {/* Right Panel */}
            {activePanel && (
                <div className="w-96 border-l border-[#1a2333] bg-[#0b1326]">
