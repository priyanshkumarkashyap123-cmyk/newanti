      ...
      <div className={`rounded-lg border-2 p-4 shadow-lg ${
        ...
        {errors.length > 0 && (
          <div className="mt-4 space-y-2">
            <h4 className="font-medium tracking-wide text-red-800">
        ...
        {warnings.length > 0 && (
          <div className="mt-4 space-y-2">
            <h4 className="font-medium tracking-wide text-yellow-800">
        ...
        {infos.length > 0 && (
          <div className="mt-4 space-y-2">
            <h4 className="font-medium tracking-wide text-blue-800">
...
const IssueCard: React.FC<{
  ...
  return (
    <div className={`bg-[#131b2e] p-3 rounded border-l-4 ${getSeverityBorderColor(issue.severity)} shadow-sm`}>
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <p className="text-sm font-medium tracking-wide text-[#dae2fd]">{issue.message}</p>
          
          {issue.affected_elements && issue.affected_elements.length > 0 && (
            <p className="text-xs text-[#869ab8] mt-1">
              <span className="font-medium tracking-wide">Affected:</span>{' '}
          ...
          {issue.suggested_fix && (
            <div className="mt-2 p-2 bg-green-900/30 rounded text-xs text-green-300 border border-green-700">
              <span className="font-medium tracking-wide">💡 Suggestion:</span> {issue.suggested_fix}
            </div>
          )}
        </div>
        ...
        {issue.auto_fixable && onAutoFix && (
          <button type="button"
            ...
            className="ml-3 px-3 py-1 text-xs font-medium tracking-wide text-white bg-green-600 hover:bg-green-700 rounded"
          >
            Auto-Fix
          </button>
        )}
