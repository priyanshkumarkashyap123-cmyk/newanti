      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          {modes.length === 0 ? (
            ...
            <>
              <div>
                <label className="block text-sm font-medium tracking-wide mb-1">Select Mode</label>
                <div className="border rounded max-h-48 overflow-y-auto">
                  {modes.map((mode: any, i: number) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-sm hover:bg-slate-100 dark:hover:bg-slate-800 ${activeModeIndex === i ? 'bg-blue-50 dark:bg-blue-900/20 font-medium tracking-wide' : ''}`}
                    >
