    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium tracking-wide mb-1">Diaphragm Type</label>
            <select
              value={type}
          ...
          <div>
            <label className="block text-sm font-medium tracking-wide mb-1">Diaphragm Plane</label>
            <select
              value={plane}
          ...
          <div>
            <label className="block text-sm font-medium tracking-wide mb-1">Story Label</label>
            <input
              type="text"
              value={storyLabel}
