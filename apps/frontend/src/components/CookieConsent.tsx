            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex items-center gap-3 flex-shrink-0 w-full sm:w-auto">
                ...
                <button type="button"
                  ...
                  className="flex-1 sm:flex-none px-5 py-2 text-sm font-medium tracking-wide bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors cursor-pointer"
                >
                  Accept
                </button>
              </div>
