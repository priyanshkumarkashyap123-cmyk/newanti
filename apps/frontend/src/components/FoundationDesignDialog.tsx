    ...
    <div className="flex flex-col gap-2">
        ...
        <div className="relative">
            <select
                ...
                className="w-full appearance-none rounded-lg border border-[#1a2333] bg-[#131b2e] text-[#dae2fd] h-11 px-4 pr-10 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all text-sm"
            >
                {options.map(opt => (
    ...
    <div className="flex flex-col gap-2">
        ...
        <div className="relative">
            <Input
                ...
                max={max}
                step={step}
                className="w-full rounded-lg border border-[#1a2333] bg-[#131b2e] text-[#dae2fd] h-11 px-4 pr-12 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all text-sm"
            />
            {unit && (
                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#869ab8] text-sm">
                    {unit}
                </span>
            )}
        </div>
            ...
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <section>
                            ...
                            <div className="flex items-center gap-4 p-4 rounded-lg border border-[#1a2333] bg-slate-100/50 dark:bg-slate-800/50">
                            ...
                            {selectedSoilData && !useCustomBearing && (
                                <div className="mt-3 p-3 rounded-lg bg-slate-100/30 dark:bg-slate-800/30 flex items-start gap-2">
                                    ...
                                    <p className="text-[#869ab8] text-sm">{selectedSoilData.description}</p>
                                </div>
                            )}
                        </section>
