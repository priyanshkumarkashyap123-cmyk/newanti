...
export class ReportGenerator {
    ...
    private addHeader(): void {
        ...
        this.doc.text(BEAMLAB_COMPANY.name, this.margin + 25, 18);
        ...
        this.doc.setFont('helvetica', 'normal');
        this.doc.text(`Generated by ${BEAMLAB_COMPANY.website}`, this.pageWidth - this.margin, 22, { align: 'right' });
    ...
    private addFooter(): void {
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            this.doc.text(
                `© ${year} ${BEAMLAB_COMPANY.name} | ${BEAMLAB_COMPANY.website}`,
                this.margin,
                this.pageHeight - 12
            );
            this.doc.text(
