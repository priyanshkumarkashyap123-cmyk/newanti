...
// Omit AnalysisResult to avoid clash with StructuralAnalysisEngine.AnalysisResult
export {
  type NodeType,
  type FrictionModel,
  type AnalysisMethod,
  ...
  type AnalysisConfig,
  type IterationLog,
  type AnalysisResult as PipeNetworkAnalysisResult,
...
export { PipeNetworkDesigner } from "./components/PipeNetworkDesigner";
