            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="flex gap-2 mt-6 border-b border-slate-200">
                    <button type="button"
                        ...
                        className={`px-4 py-2 text-sm font-medium tracking-wide border-b-2 transition-colors ${activeTab === 'highway'
                    ...
                    <button type="button"
                        ...
                        className={`px-4 py-2 text-sm font-medium tracking-wide border-b-2 transition-colors ${activeTab === 'pavement'
                            ? 'border-orange-500 text-orange-600'
                            : 'border-transparent text-slate-500 hover:text-slate-700'
                            }`}
                    >
                    ...
                    <button type="button"
                        ...
                        className={`px-4 py-2 text-sm font-medium tracking-wide border-b-2 transition-colors ${activeTab === 'intersection'
                            ? 'border-orange-500 text-orange-600'
                            : 'border-transparent text-slate-500 hover:text-slate-700'
                            }`}
                    >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xs font-medium tracking-wide text-slate-700 mb-1">Road Class</label>
                            <select
                        ...
                        <div>
                            <label className="block text-xs font-medium tracking-wide text-slate-700 mb-1">Terrain</label>
                            <select
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg flex justify-between items-center">
                        <span className="text-sm text-orange-800 font-medium tracking-wide">Design Speed (IRC 73)</span>
            ...
            <div className="space-y-6">
                ...
                {(curveResult || verticalResult) && (
                    <button type="button"
                        ...
                        className="w-full py-2 bg-[#131b2e] text-[#dae2fd] rounded-lg text-sm font-medium tracking-wide hover:bg-slate-200 dark:hover:bg-slate-900"
                    >
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-xs font-medium tracking-wide text-slate-700 mb-1">Pavement Type</label>
                        ...
                        <div className="border rounded-lg overflow-hidden">
                            {result.layers.map((layer: any, idx: number) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span className="font-medium tracking-wide text-sm">{layer.name}</span>
                                        <span className="text-sm font-mono">{layer.thickness} mm</span>
                                    </div>
                                );
                            })}
                            <div className="bg-orange-100 h-12 flex items-center px-4 text-orange-800 text-sm font-medium tracking-wide border-t border-orange-200">
                        ...
                        <div className="mt-6 space-y-2">
                            ...
                            {result.layers.map((layer: any, idx: number) => (
                                <div key={idx} className="flex justify-between text-sm py-1 border-b last:border-0 border-slate-100">
                                    ...
                                    <span className="font-medium tracking-wide">{layer.material} ({layer.thickness} mm)</span>
                                </div>
                            ))}
                        </div>
                    </div>
