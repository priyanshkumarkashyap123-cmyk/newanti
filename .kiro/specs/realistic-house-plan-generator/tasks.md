...
- [ ] 3. Implement architectural placement pipeline in SpacePlanningEngine.ts

  - [ ] 3.1 Add `NBC_MIN_DIMS` constant and `ArchitecturalZone` enum
  ...
  - [ ] 3.2 Add `ROOM_ZONE_MAP` constant and `PlacementContext` interface
  ...
  - [ ] 3.3 Implement `classifyRoomZone()` and `enforceNBCMinDimensions()` private methods
  ...
  - [ ] 3.4 Implement `buildCirculationSpine()` private method
  ...
  - [ ] 3.5 Implement `placePublicZone()` private method
  ...
  - [ ] 3.6 Implement `placeWetAreas()` private method
  ...
  - [ ] 3.7 Implement `placePrivateZone()` private method
  ...
  - [ ] 3.8 Implement `autoInjectMandatoryRooms()` private method
  ...
  - [ ] 3.9 Implement `validateEntranceSequence()` private method
  ...
  - [ ] 3.10 Implement `architecturalPlacement()` orchestrator method
  ...
  - [ ] 3.11 Modify `generateFloorPlan()` to call `architecturalPlacement()` instead of `placeRooms()`
...
- [ ] 4. Write fix-checking tests (expected to PASS after fix)
