...
class AIArchitectService {
   ...
   */
  static async generateStructure(userPrompt) {
    try {
   ...
   */
  static async generateFallback(prompt) {
...
var AIArchitectService_default = AIArchitectService;
export {
  AIArchitectService,
  AIArchitectService_default as default
};
//# sourceMappingURL=AIArchitectService.js.map
